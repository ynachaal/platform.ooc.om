			 ...
			 <div class="col-md-12">
				<div class="card card-primary">
				   ...
				   <form role="form" id="quickForm1" method="POST" action="{{ url('/forms/save_form1') }}" enctype="multipart/form-data">
						...
						<label><i class="fas fa-circle"></i> Programme (Long Form)</label>
						  <input type="text" name="programme_log" class="form-control" value="{{isset($data['programme_log'])? $data['programme_log'] : ''}}">
						
						<label><i class="fas fa-circle"></i>quard/Game Edition</label>
						...
						<p>Program Help/Instructional Text</p>
								<p>Support ofr one national winter or summer team per NOC is available annually over the 2021-2024 plan. the support may be split between two terms provided one of the teams is awomen's team in this case both applications must be submitted at the same time. NOCs with a team that benefited from Team Support Grant program during the 2017-2020 plan that is either qualified for the Olympic Games Tokyo 2020 or still able to, may apply for the additional Tokyo extension grant for team up until the Tokyo Olympic Game. In this case the "Team Support Grant Extension" Program should be selected in the drop down menu of the program. This option can be applied for in addition to the regular 2021-2024 team Suport Grant programme.</p>
						 ...
						 <div class="form-row col">
							...
							<h3>Sport Selection</h3>
							 <div class="card sport_card">
								...
								<?php } ?>
									...
									<div class="form-row col">
										<div class="col">
											<label>Season</label>
											  <input type="text" name="season" class="form-control" value="{{isset($data['season'])? $data['season'] : ''}}">
											 <div class="required_error">&nbsp;</div>
									...
									<div class="form-row col">
										<div class="col">
											...
											<input type="text" class="form-control required" value="{{isset($data['if_p'])? $data['if_p'] : ''}}" name="if_p">
											 <div class="required_error">&nbsp;</div>
							 ...
							 <div class="sport">
							<h3>Best result-Brief historical summary with result of the team</h3>
							 <div class="card sport_card">
								<div class="d-md-flex align-items-center">
								<div class="row">
								<div class="col-md-6">
									<div class="form-row col">
										<div class="col">
											<label><i class="fas fa-circle"></i>Event</label>
											 <input type="text" name="event" class="form-control" value="{{isset($data['event'])? $data['event'] : ''}}">
											 <div class="required_error">&nbsp;</div>
									...
									<div class="col">
										...
										<div class="col">
											<label><i class="fas fa-circle"></i>Result</label>
											 <input type="text" name="result" class="form-control" value="{{isset($data['result'])? $data['result'] : ''}}">
											 <div class="required_error">&nbsp;</div>
										</div>
									</div>
									</div>
							...
							<h3>Best/Major Competition</h3>
							 <div class="card sport_card">
								...
								<div class="row">
									...
									<div class="col-md-6">
										<div class="col">
											<label><i class="fas fa-circle"></i>Competition</label>
											 <input type="text" name="competition" class="form-control" value="{{isset($data['competition'])? $data['competition'] : ''}}">
											 <div class="required_error">&nbsp;</div>
										</div>
									</div>
									<div class="col-md-6">
									<div class="col">
											<label><i class="fas fa-circle"></i> Territory/Location</label>
											<select class="form-control required" name="activity_location2[]" aria-label="Default select example">
												  <option value=""></option>  
												  <?php foreach($locations as $vals){ ?>
												<option <?php if(isset($data['activity_location2'][0]) && $data['activity_location2'][0]==$vals) echo 'selected' ?> value="<?php echo $vals ?>"><?php echo $vals ?></option>
												<?php } ?>
											</select>
											  <div class="required_error">&nbsp;</div>
										</div>
