...
.budget{
	...
	<section class="content-header">
	   <div class="container-fluid">
		  <div class="row mb-2">
			 <div class="col-sm-6">
				<h1>Continental Athlete Support Grant</h1>
			 </div>
			 <div class="col-sm-6">
				<ol class="breadcrumb float-sm-right">
				   <li class="breadcrumb-item"><a href="#">Home</a></li>
				   <li class="breadcrumb-item active">Continental Athlete Support Grant</li>
				</ol>
			 </div>
		  </div>
	   </div>
			 ...
			 <div class="col-md-12">
				<div class="card card-primary">
				   <div class="card-header">
					  <h3 class="card-title">Continental Athlete Support Grant</h3>
				   </div>
				   <!-- /.card-header -->
				   <!-- form start -->
				   <form role="form" id="quickForm1" onsubmit="return submit_action();" method="POST" action="{{ url('/forms/save_form1') }}" enctype="multipart/form-data">
					  ...
					  @endif
                       <br>
                         <div class="col-md-4">
										<div class="col">
											<label><i class="fas fa-circle"></i>Activities start year for which you wish to request
the Continental Athlete Support Grant</label>
						 ...
						 <div class="form-group col-md-6">
							 ...
							 <h3>Multi-sport Games/Competitions</h3>
							 <?php
							 if(!empty($data))
							 {
							$num=count($data['competition_name']);
							for($i=0;$i<$num;$i++)
						{
						?>	
					<div class="Multi-sport-Games">
					...
					float: left;">
                       ...
                       <div class="col-md-3">
									<div class="form-row col">
										<div class="col">
											<label><i class="fas fa-circle"></i>Event/Activity/Compatition Name</label>
											<input type="text" value="<?php if(isset($data['competition_name'][$i]) && !empty($data['competition_name'][$i])) echo $data['competition_name'][$i] ?>" class="form-control required" name="competition_name[]">
											 <div class="required_error">&nbsp;</div>
										</div>
									</div>
									</div>
									...
									<div class="form-row col">
										<div class="col">
											...
											<input type="date" value="<?php if(isset($data['end_date'][$i]) && !empty($data['end_date'][$i])) echo $data['end_date'][$i] ?>" class="form-control required" name="end_date[]">
											 <div class="required_error">&nbsp;</div>
										</div>
									</div>
									</div>
									...
									<div class="form-row col">
										<div class="col">
											<label><i class="fas fa-circle"></i>Teritorylocation</label>
											<select  name="locations[]"  class="form-control required" aria-label="Default select example">
												  <option value=""></option> 
												  <?php foreach($locations as $vals){ ?>
				 ...
				 <div class="card sport_card" style="width: 100%;
					float: left;">
                       ...
                       <div class="col-md-3">
									<div class="form-row col">
										<div class="col">
											<label><i class="fas fa-circle"></i>Event/Activity/Compatition Name</label>
											<input type="text" value="<?php if(isset($data['competition_name']) && !empty($data['competition_name'])) echo $data['competition_name'] ?>" class="form-control required" name="competition_name[]">
											 <div class="required_error">&nbsp;</div>
										</div>
									</div>
									</div>
					...
					<br><br>
                            ...
                            <div class="card sport_card" id="container" style="width: 100%;float: left;">
							 <h4>Activities</h4>
                            	<h2>Year 1 Activities</h2>
                            	<div class="col-md-12">
									...
									<p>* Year 1 refers to your NOC “activities start year” as noted in the box above.</p>
										...
										<input type="number" class="form-control all_percentage p1 toSum" id="p1"  name="year_1_percentage" placeholder="%" value="{{isset($data['year_1_percentage'])? $data['year_1_percentage'] : ''}}">
										<div class="required_error">&nbsp;</div>
								</div>                         
								  
	                       <div class="col-md-12">
									<h4>Brief list of activities that your NOC intends to organise this year in preparation of the listed competitions</h4>
                                 ...
                                 <br>
                                 <h2>Year 2 Activities</h2>
                            	<div class="col-md-12">
                            		
									<p>* Year 1 refers to your NOC “activities start year” as noted in the box above.</p>
									 
										<p>Percentage of the total budget you wish to dedicate to this year</p>
										<input type="number" class="form-control all_percentage p2 toSum"  id="p2" placeholder="%"  value="{{isset($data['year_2_percentage'])? $data['year_2_percentage'] : ''}}" name="year_2_percentage">
										<div class="required_error">&nbsp;</div>
									 </div>
                                 <h4>Brief list of activities that your NOC intends to organise this year in preparation of the listed competitions</h4>
								 <div class="col-md-12">
                                 ...
                                 <br>
                                 <h2>Year 3 Activities</h2>
                            	<div class="col-md-12">
                            		
									<p>* Year 1 refers to your NOC “activities start year” as noted in the box above.</p>
									 
										<p>Percentage of the total budget you wish to dedicate to this year</p>
										<input type="number" class="form-control all_percentage p3 toSum"  id="p3" placeholder="%" value="{{isset($data['year_3_percentage'])? $data['year_3_percentage'] : ''}}" name="year_3_percentage">
									 </div>
									 <h4>Brief list of activities that your NOC intends to organise this year in preparation of the listed competitions</h4>
								 <div class="col-md-12">
                                 ...
                                 <h2>Year 4 Activities</h2>
                            	<div class="col-md-12">
                            		
									<p>* Year 1 refers to your NOC “activities start year” as noted in the box above.</p>
									 
										<p>Percentage of the total budget you wish to dedicate to this year</p>
										<input type="number" class="form-control all_percentage p4 toSum" id="p4" placeholder="%" value="{{isset($data['year_4_percentage'])? $data['year_4_percentage'] : ''}}" name="year_4_percentage">
										<div class="required_error">&nbsp;</div>
									 </div>
									 <h4>Brief list of activities that your NOC intends to organise this year in preparation of the listed competitions</h4>
								 <div class="col-md-12">
									 ...
									 <div class="card sport_card">
										...
										<p>Total Activities Percentage %</p>
										 <input type="text" class="form-control" placeholder="%"  name="" id="totalSum" >
										<p style="color: red;">Total is 100%</p>
										<div class="required_error">&nbsp;</div>
									 </div>                        
								 </div>
									 </div> 
...
$(add_button).click(function(e){
	...
	if(total_fields < max_fields){
		$(wrapper).append('<div class="Multi-sport-Games"><div class="card sport_card" style="width: 100%;float: left;"><div class="row"><div class="col-md-3"><div class="form-row col"><div class="col"><label><i class="fas fa-circle"></i>Event/Activity/Compatition Name</label><input type="text" class="form-control required" name="competition_name[]"><div class="required_error">&nbsp;</div></div></div></div><div class="col-md-3"><div class="form-row col"><div class="col"><label><i class="fas fa-circle"></i>Start date</label><input type="date"  class="form-control required" name="start_date[]"><div class="required_error">&nbsp;</div></div></div></div><div class="col-md-3"><div class="form-row col"><div class="col"><label><i class="fas fa-circle"></i>End date </label><input type="date"  class="form-control required" name="end_date[]"><div class="required_error">&nbsp;</div></div></div></div><div class="col-md-3"><div class="form-row col"><div class="col"><label><i class="fas fa-circle"></i>Teritorylocation</label><select  name="locations[]"  class="form-control required" aria-label="Default select example"><option value=""></option> <?php foreach($locations as $vals){ ?><option <?php if(isset($data['locations[]']) && $data['locations[]']==$vals) echo 'selected' ?> value="<?php echo $vals ?>"><?php echo $vals ?></option><?php } ?></select> <div class="required_error">&nbsp;</div></div></div></div></div></div></div>');
		 $('.textarea').summernote();
	}
});
