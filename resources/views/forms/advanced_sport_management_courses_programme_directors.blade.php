...
.budget{
	...
	<section class="content-header">
	   <div class="container-fluid">
		  <div class="row mb-2">
			 <div class="col-sm-6">
				<h1>National Courses for Sport Administrators - Advanced Sport Management Courses - Programme Directors</h1>
			 </div>
			 <div class="col-sm-6">
			 ...
			 <div class="col-md-12">
				<div class="card card-primary">
				   <div class="card-header">
					  <h3 class="card-title">National Courses for Sport Administrators - Advanced Sport Management Courses - Programme Directors</h3>
				   </div>
				   <!-- /.card-header -->
				   <!-- form start -->
				   <form role="form" id="quickForm1" method="POST" action="{{ url('/forms/save_form1') }}" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
						 <div class="form-group col-md-6">
                            ...
                            <div class="sport">
							<h3>Please enter the name of the Program Director</h3>
							<p>Please make sure to include a personal email address for the PD candidate as this information will be needed to keep the right flow of the process.</p>
								...
								<div class="d-md-flex align-items-center">
									...
									<div class="form-row col">
										<div class="col">
											...
											<input type="text" value="{{isset($data['given_name'])?$data['given_name'] : ''}}" name="given_name" class="form-control required">
									...
									<div class="form-row col">
										<div class="col">
											...
											<input type="text" value="{{isset($data['family_name'])?$data['family_name'] : ''}}" name="family_name" class="form-control required">
											<div class="required_error">&nbsp;</div>
										</div>
									</div>
									</div>
									...
									<div class="form-row col">
										<div class="col">
											<label><i class="fas fa-circle"></i>Function</label>
											<input type="text" value="{{isset($data['function'])?$data['function'] : ''}}" name="function" class="form-control required">
											<div class="required_error">&nbsp;</div>
										</div>
									</div>
									</div>
									...
									<div class="form-row col">
										<div class="col">
											...
											<input type="text" value="{{isset($data['email'])?$data['email'] : ''}}" name="email" class="form-control required">
											<div class="required_error">&nbsp;</div>
										</div>
									</div>
									</div>
									...
									<div class="form-row col">
										<div class="col">
											...
											<input type="text" value="{{isset($data['organisation'])?$data['organisation'] : ''}}" name="organisation" class="form-control required">
											<div class="required_error">&nbsp;</div>
										</div>
									</div>
									</div>
						  ...
						  <div class="sport sport_education" >
							<h3>Education and professional training (Please emphasise training in sport management and education)</h3>
							 <?php
							 if(!empty($data))
							 {
							...
							for($i=0;$i<$num;$i++)
							 ...
							 <div class="card sport_card ">
								<div class="d-md-flex align-items-center">
									...
									<div class="form-row col">
										<div class="col">
											<label><i class="fas fa-circle"></i>Degree/Course,Diploma,Certificate,etc</label>
											<input type="text" value="<?php if(isset($data['degree'][$i]) && !empty($data['degree'][$i])) echo $data['degree'][$i] ?>" name="degree[]" class="form-control required">
											<div class="required_error">&nbsp;</div>
										</div>
									</div>
									</div>
									...
									<div class="form-row col">
										<div class="col">
											...
											<input type="text" value="<?php if(isset($data['institution'][$i]) && !empty($data['institution'][$i])) echo $data['institution'][$i] ?>" name="institution[]" class="form-control required">
											<div class="required_error">&nbsp;</div>
										</div>
									</div>
									</div>
									...
									<div class="form-row col">
										<div class="col">
											...
											<input type="text" value="<?php if(isset($data['year'][$i]) && !empty($data['year'][$i])) echo $data['year'][$i] ?>" name="year[]" class="form-control required">
											<div class="required_error">&nbsp;</div>
										</div>
									</div>
									</div>
							   ...
							   <div class="card sport_card ">
								<div class="d-md-flex align-items-center">
									...
									<div class="form-row col">
										<div class="col">
											<label><i class="fas fa-circle"></i>Degree/Course,Diploma,Certificate,etc</label>
											<input type="text" value="<?php if(isset($data['degree']) && !empty($data['degree'])) echo $data['degree'] ?>" name="degree[]" class="form-control required">
											<div class="required_error">&nbsp;</div>
										</div>
									</div>
									</div>
									...
									<div class="form-row col">
										<div class="col">
											<label><i class="fas fa-circle"></i>Institution/University</label>
											<input type="text" value="<?php if(isset($data['institution']) && !empty($data['institution'])) echo $data['institution'] ?>" name="institution[]" class="form-control required">
											<div class="required_error">&nbsp;</div>
										</div>
									</div>
									</div>
									...
									<div class="form-row col">
										<div class="col">
											<label><i class="fas fa-circle"></i>Year</label>
											<input type="text" value="<?php if(isset($data['year']) && !empty($data['year'])) echo $data['year'] ?>" name="year[]" class="form-control required">
											<div class="required_error">&nbsp;</div>
										</div>
									</div>
									</div>
							...
							<button type="button" name="" class="btn btn-success add_education" >Add</button>
							</div>	

						 <br>  <br>
							<div class="sport">
							<h3>Professional experience and motivation</h3>
							 ...
							 <div class="card sport_card">
								<div class="d-md-flex align-items-center">
									...
									<div class="col-md-12">
										<div class="col">
											<label><i class="fas fa-circle"></i>Are you currently or have you in the past involved in managing a sport organisation(in a voluntary or paid position)? Please provide related information (organisation, positions, tasks, dates of involement).</label>
											
											<textarea rows="4" class="form-control required" name="translator_qualifications">{{isset($data['translator_qualifications'])?$data['translator_qualifications']: ''}}</textarea>
											 <div class="required_error">&nbsp;</div>
									...
									<div class="col-md-12">
										<div class="col">
											<label><i class="fas fa-circle"></i>Are you currently or have yoy in the past been involved in managing a non-sporting organisation (in a voluntary or paid position)? Please provide related information.</label>
											
											<textarea rows="4" class="form-control required" name="translator_qualifications2">{{isset($data['translator_qualifications2'])?$data['translator_qualifications2']: ''}}</textarea>
											 <div class="required_error">&nbsp;</div>
									...
									<div class="col-md-12">
										<div class="col">
											<label><i class="fas fa-circle"></i>Are you currently or have you in the past been involved in teaching activites organised by a sport organisation or in a non-sporting context on a regular basis? Please provide related information.</label>
											
											<textarea rows="4" class="form-control required" name="translator_qualifications3">{{isset($data['translator_qualifications3'])?$data['translator_qualifications3']: ''}}</textarea>
											 <div class="required_error">&nbsp;</div>
									...
									<div class="col-md-12">
										<div class="col">
											<label><i class="fas fa-circle"></i>Please describe any other sport-related experience you have.</label>
											
											<textarea rows="4" class="form-control required" name="translator_qualifications5">{{isset($data['translator_qualifications5'])?$data['translator_qualifications5']: ''}}</textarea>
											 <div class="required_error">&nbsp;</div>
									...
									<div class="col-md-12">
										<div class="col">
											<label><i class="fas fa-circle"></i>?What assets can you to the organisation of Advanced Sport Management Courses</label>
											
											<textarea rows="4" class="form-control required" name="translator_qualifications6">{{isset($data['translator_qualifications6'])?$data['translator_qualifications6']: ''}}</textarea>
											 <div class="required_error">&nbsp;</div>
									...
									<!-- Setion Add-->
									 ...
									 <div class="col-md-12">
									 	<p>Have you taken part in an ASMC?</p>
										</div>
									 <div class="col-md-2">
                      <div class="form-check form-check-inline">
   <input class="form-check-input" type="checkbox" id="inlineCheckbox1" name="yes"  value="Active" {{isset($data['yes']) && $data['yes']  == "Active" ? 'checked' : ''}} />
  <label class="form-check-label" for="inlineCheckbox1">yes</label>
</div>
</div>
<div class="col-md-2">
<div class="form-check form-check-inline">
   <input class="form-check-input" type="checkbox" id="inlineCheckbox1" name="no"  value="Active2" {{isset($data['no']) && $data['no']  == "Active2" ? 'checked' : ''}} />
...
<div class="col-md-2">
<p><i class="fas fa-circle"></i>Managing Olympic Sport Organisation</p>
 </div>
 <div class="row">								

<div class="col-md-12">
<p>Have you read Managing Olympic sport Organisation?</p>
 </div>
 </div>
 <br>
 <br>
 <div class="col-md-1">
       <div class="form-check form-check-inline">
   <input class="form-check-input" type="checkbox" id="inlineCheckbox1" name="yes"  value="Active3" {{isset($data['yes']) && $data['yes']  == "Active3" ? 'checked' : ''}} />
  <label class="form-check-label" for="inlineCheckbox1">yes</label>
</div>
</div>
...
<div class="col-md-1">
<div class="form-check form-check-inline">
   <input class="form-check-input" type="checkbox" id="inlineCheckbox1" name="no"   value="Partially" {{isset($data['Partially']) && $data['Partially']  == "Partially" ? 'checked' : ''}} />
  <label class="form-check-label" for="inlineCheckbox2">Partially</label>
</div>
</div>
<div class="col-md-1">
<div class="form-check form-check-inline">
   <input class="form-check-input" type="checkbox" id="inlineCheckbox1" name="no"  value="Active4" {{isset($data['no']) && $data['no']  == "Active4" ? 'checked' : ''}} />
  <label class="form-check-label" for="inlineCheckbox2">No</label>
</div>
</div>
</div>
									...
									<div class="col-md-12">
										<div class="col">
											<label><i class="fas fa-circle"></i>?What did you like best about the manual ?What topic(s) do you expect to be the biggest challenge during the course</label>
											
											<textarea rows="4" class="form-control required" name="translator_qualifications7">{{isset($data['translator_qualifications7'])?$data['translator_qualifications7']: ''}}</textarea>
											 <div class="required_error">&nbsp;</div>
									...
									<div class="col-md-12">
										<div class="col">
											<label><i class="fas fa-circle"></i>?Will you be able to devote the required amount of time(more than 100 hours) to organising and conducting advanced sport management courses?how do you plan to ensure that</label>
											
											<textarea rows="4" class="form-control required" name="translator_qualifications8">{{isset($data['translator_qualifications8'])?$data['translator_qualifications8']: ''}}</textarea>
											 <div class="required_error">&nbsp;</div>
...
var max_fields_d      = 20;
var wrapper_d         = $(".sport_education"); 
var add_button_d      = $(".add_education");
...
$(add_button_d).click(function(e){
	...
	if(total_fields_d < max_fields_d){
		$(wrapper_d).append('<div class="card sport_card "><div class="d-md-flex align-items-center"><div class="row"><div class="col-md-6 col-sm-12"><div class="form-row col"><div class="col"><label><i class="fas fa-circle"></i>Degree/Course,Diploma,Certificate,etc</label><input type="text"  name="degree[]" class="form-control required"><div class="required_error">&nbsp;</div></div></div></div><div class="col-md-3 col-sm-12"><div class="form-row col"><div class="col"><label><i class="fas fa-circle"></i>Institution/University</label><input type="text" " name="institution[]" class="form-control required"><div class="required_error">&nbsp;</div></div></div></div><div class="col-md-3 col-sm-12"><div class="form-row col"><div class="col"><label><i class="fas fa-circle"></i>Year</label><input type="text"  name="year[]" class="form-control required"><div class="required_error">&nbsp;</div></div></div></div></div>	</div></div>');
		 $('.textarea').summernote();
	}
});
...
$(add_button).click(function(e){
	...
	if(total_fields < max_fields){
		$(wrapper).append('<div class="card sport_card Languages" style="width: 100%;float: left;"><div class="row"><div class="col-md-6"><div class="form-row col"><div class="col"><label><i class="fas fa-circle"></i>Language</label><input type="text" " class="form-control required" name="Language[]"><div class="required_error">&nbsp;</div></div></div></div><div class="col-md-12"><label><i class="fas fa-circle"></i>Spoken</label></div><br><div class="col-md-3"> <div class="form-check form-check-inline"><input class="form-check-input" type="checkbox" id="inlineCheckbox1" name="Spoken_Beginner[]"  /><label class="form-check-label" for="inlineCheckbox1">Beginner</label></div></div><div class="col-md-3"><div class="form-check form-check-inline"><input class="form-check-input" type="checkbox" id="inlineCheckbox1" name="Spoken_intermediate[]" /><label class="form-check-label" for="inlineCheckbox2">Intermediate</label></div></div><div class="col-md-3"><div class="form-check form-check-inline"><input class="form-check-input" type="checkbox" id="inlineCheckbox1" name="Spoken_advanced[]"  /><label class="form-check-label" for="inlineCheckbox2">Advanced</label></div></div><div class="col-md-3"><div class="form-check form-check-inline"><input class="form-check-input" type="checkbox" id="inlineCheckbox1" name="Spoken_fluent[]"  /><label class="form-check-label" for="inlineCheckbox2">Fluent</label></div></div><br><br><div class="col-md-12"><label><i class="fas fa-circle"></i>Witten</label></div><br><div class="col-md-3"><div class="form-check form-check-inline"><input class="form-check-input" type="checkbox" id="inlineCheckbox1" name="Witten_beginner[]"  /><label class="form-check-label" for="inlineCheckbox1">Beginner</label></div></div><div class="col-md-3"><div class="form-check form-check-inline"><input class="form-check-input" type="checkbox" id="inlineCheckbox1" name="Witten_intermediate[]"  /><label class="form-check-label" for="inlineCheckbox2">Intermediate</label></div></div><div class="col-md-3"><div class="form-check form-check-inline"><input class="form-check-input" type="checkbox" id="inlineCheckbox1" name="Witten_advanced[]"  /><label class="form-check-label" for="inlineCheckbox2">Advanced</label></div></div><div class="col-md-3"><div class="form-check form-check-inline"><input class="form-check-input" type="checkbox" id="inlineCheckbox1" name="Witten_fluent[]"  /><label class="form-check-label" for="inlineCheckbox2">Fluent</label></div></div><br><br><div class="col-md-12"><label><i class="fas fa-circle"></i>Read</label></div><br><div class="col-md-3"><div class="form-check form-check-inline"><input class="form-check-input" type="checkbox" id="inlineCheckbox1" name="Read_beginner[]" /><label class="form-check-label" for="inlineCheckbox1">Beginner</label></div></div><div class="col-md-3"><div class="form-check form-check-inline"><input class="form-check-input" type="checkbox" id="inlineCheckbox1" name="Read_intermediate[]" /><label class="form-check-label" for="inlineCheckbox2">Intermediate</label></div></div><div class="col-md-3"><div class="form-check form-check-inline"><input class="form-check-input" type="checkbox" id="inlineCheckbox1" name="Read_advanced[]"  /><label class="form-check-label" for="inlineCheckbox2">Advanced</label></div></div><div class="col-md-3"><div class="form-check form-check-inline"><input class="form-check-input" type="checkbox" id="inlineCheckbox1" name="Read_fluent[]"  /><label class="form-check-label" for="inlineCheckbox2">Fluent</label></div></div></div></div>');
		 $('.textarea').summernote();
	}
});
