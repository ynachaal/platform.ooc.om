...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1>Team Support Grant Tokyo 2020 - extension</h1>
            </div>
            <div class="col-sm-6">
            ...
            <div class="col-md-12">
                ...
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title">Team Support Grant Tokyo 2020 - extension</h3>
                    </div>
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form role="form" id="quickForm1" method="POST" action="{{ url('/forms/save_form1') }}" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            ...
                            <h3 class="form_header_2" style="margin-top: 20px; color: #007bff;font-weight: 600;">BUDGET PROPOSAL </h3>
               
               
               <div class="card sport_card Diploma_Certificate" id='container' style="width: 100%;
    float: left;">
    <h3 style="vertical-align: inherit;color: #007bff;font-weight: 600;">Detailed breakdown of budget requested from Olympic Solidarity </h3>
				...
				<div class="row">
                       ...
                       <div class="col-md-6">
									<div class="form-row col">
										<div class="col">
											<label><i class="fas fa-circle" style="font-size: 8px; margin: 2px;color: red;"></i>Description</label>
									...
									<div class="form-row col">
										<div class="col">
											<label><i class="fas fa-circle" style="font-size: 8px; margin: 2px;color: red;"></i>Amount(USD)</label>
				...
				<?php } ?>
						...
						<div class="col-md-6">
									<div class="form-row col">
										<div class="col">
											<label><i class="fas fa-circle" style="font-size: 8px; margin: 2px;color: red;"></i>Total budget requested(USD)</label>
