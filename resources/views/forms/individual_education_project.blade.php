...
.budget{
	...
	<section class="content-header">
	   <div class="container-fluid">
		  <div class="row mb-2">
			 <div class="col-sm-6">
				<h1>Athlete Career Transition - Athletes Education - Individual Education Project</h1>
			 </div>
			 <div class="col-sm-6">
				<ol class="breadcrumb float-sm-right">
				   <li class="breadcrumb-item"><a href="#">Home</a></li>
				   <li class="breadcrumb-item active">Athlete Career Transition - Athletes Education - Individual Education Project</li>
				</ol>
			 </div>
		  </div>
	   </div>
			 ...
			 <div class="col-md-12">
				<div class="card card-primary">
				   <div class="card-header">
					  <h3 class="card-title">Athlete Career Transition - Athletes Education - Individual Education Project</h3>
				   </div>
				   <!-- /.card-header -->
				   <!-- form start -->
							 ...
							 <div class="card sport_card ">
									...
									<div class="form-row col">
										<div class="col">
											...
											<input type="text" value="<?php if(isset($data['given_name'][0]) && !empty($data['given_name'][0])) echo $data['given_name'][0] ?>" class="form-control required" name="given_name[]">
									...
									<div class="form-row col">
										<div class="col">
											...
											<input type="text" value="<?php if(isset($data['family_name'][0]) && !empty($data['family_name'][0])) echo $data['family_name'][0] ?>" class="form-control required" name="family_name[]">
											 <div class="required_error">&nbsp;</div>
										</div>
									</div>
									</div>
						...
						<?php } ?>
									...
									<div class="form-row col">
										<div class="col">
											...
											<input type="date" value="<?php if(isset($data['date_of_birth'][0]) && !empty($data['date_of_birth'][0])) echo $data['date_of_birth'][0] ?>" class="form-control required" name="date_of_birth[]">
											 <div class="required_error">&nbsp;</div>
										</div>
									</div>
									</div>
									...
									<div class="form-row col">
										<div class="col">
											<label><i class="fas fa-circle"></i>Country/Teritory</label>
								...
								<div class="col-md-3">
									<div class="form-row col">
										<div class="col">
											...
											<input type="text" value="<?php if(isset($data['email_add'][0]) && !empty($data['email_add'][0])) echo $data['email_add'][0] ?>" class="form-control required" name="email_add[]">
											 <div class="required_error">&nbsp;</div>
										</div>
									</div>
									</div>
								...
								<?php } ?>
                                    ...
                                    <div class="col-md-12">
                        <p>Current Athlete Career Status</p>
                                      </div>
                                    <br>
                                    <div class="col-md-3">
                      <div class="form-check form-check-inline">
  <input class="form-check-input" type="checkbox" id="inlineCheckbox1" name="career_ststus1" value="Active" {{isset($data['career_ststus1']) && $data['career_ststus1']  == "Active" ? 'checked' : ''}} />
  <label class="form-check-label" for="inlineCheckbox1">Active</label>
</div>
</div>
<div class="col-md-3">
<div class="form-check form-check-inline">
  <input class="form-check-input" type="checkbox" id="inlineCheckbox2" name="career_ststus2" value="Retirement foreseen within the next 2 years" {{isset($data['career_ststus2']) && $data['career_ststus2']  == "Retirement foreseen within the next 2 years" ? 'checked' : ''}} />
  <label class="form-check-label" for="inlineCheckbox2">Retirement foreseen within the next 2 years</label>
</div>
</div>
<div class="col-md-3">
<div class="form-check form-check-inline">
  <input class="form-check-input" type="checkbox" id="inlineCheckbox2" value="Retired" name="career_ststus3"  {{isset($data['career_ststus3']) && $data['career_ststus3']  == "Retired" ? 'checked' : ''}}/>
 ...
 <br>
	                       <div class="col-md-12">
									<p>Candidate's motivation for this application (past professional experience, objectives, career plan, etc.)</p>
									 <div class="card sport_card">
										<p>Details</p>
...
<br>
 ...
 <h3>Previous Olympics Participation</h3>
 <div class="card sport_card" style="width: 100%;
    float: left;">
                       ...
                       <div class="col-md-6">
									<div class="form-row col">
										<div class="col">
											<label><i class="fas fa-circle"></i>Has this Athlete participated in previous Olympic Games?</label>
								...
								<?php } ?>
                                  ...
                                  <br>
                                  <br>
         <h3>Primary sporting achievement(s)</h3>
 <div class="card sport_card achievement" style="width: 100%;
    float: left;">
				<?php
					 if(!empty($data))
					 {
					$num=count($data['Competition_date']);
					for($i=0;$i<$num;$i++)
				{
				?>	
					<div class="row">
                       ...
                       <div class="col-md-3">
									<div class="form-row col">
										<div class="col">
											<label><i class="fas fa-circle"></i>Event/Activity/Competition</label>
											<input type="text" value="<?php if(isset($data['Competition_date'][$i]) && !empty($data['Competition_date'][$i])) echo $data['Competition_date'][$i] ?>"class="form-control required" name="Competition_date[]">
											 <div class="required_error">&nbsp;</div>
										</div>
									</div>
									</div>
									...
									<div class="form-row col">
										<div class="col">
											...
											<input type="text" value="<?php if(isset($data['location'][$i]) && !empty($data['location'][$i])) echo $data['location'][$i] ?>" class="form-control required" name="location[]">
											 <div class="required_error">&nbsp;</div>
										</div>
									</div>
									</div>
									...
									<div class="form-row col">
										<div class="col">
											<label><i class="fas fa-circle"></i>Date </label>
											<input type="date" value="<?php if(isset($data['date'][$i]) && !empty($data['date'][$i])) echo $data['date'][$i] ?>" class="form-control required" name="date[]">
											 <div class="required_error">&nbsp;</div>
										</div>
									</div>
									</div>
									...
									<div class="form-row col">
										<div class="col">
											<label><i class="fas fa-circle"></i>Result</label>
											<input type="text" value="<?php if(isset($data['result'][$i]) && !empty($data['result'][$i])) echo $data['result'][$i] ?>" class="form-control required" name="result[]">
											 <div class="required_error">&nbsp;</div>
										</div>
									</div>
									</div>
                       ...
                       <div class="col-md-3">
									<div class="form-row col">
										<div class="col">
											<label><i class="fas fa-circle"></i>Event/Activity/Competition</label>
											<input type="text" value="<?php if(isset($data['Competition_date']) && !empty($data['Competition_date'])) echo $data['Competition_date'] ?>" class="form-control required" name="Competition_date[]">
											 <div class="required_error">&nbsp;</div>
										</div>
									</div>
									</div>
									...
									<div class="form-row col">
										<div class="col">
											<label><i class="fas fa-circle"></i>Location</label>
											<input type="text" value="<?php if(isset($data['location']) && !empty($data['location'])) echo $data['location'] ?>" class="form-control required" name="location[]">
											 <div class="required_error">&nbsp;</div>
										</div>
									</div>
									</div>
									...
									<div class="form-row col">
										<div class="col">
											<label><i class="fas fa-circle"></i>Date </label>
											<input type="date" value="<?php if(isset($data['date']) && !empty($data['date'])) echo $data['date'] ?>" class="form-control required" name="date[]">
											 <div class="required_error">&nbsp;</div>
										</div>
									</div>
									</div>
									...
									<div class="form-row col">
										<div class="col">
											<label><i class="fas fa-circle"></i>Result</label>
											<input type="text" value="<?php if(isset($data['result']) && !empty($data['result'])) echo $data['result'] ?>" class="form-control required" name="result[]">
											 <div class="required_error">&nbsp;</div>
										</div>
									</div>
									</div>
								 ...
								 <?php } ?>
									 ...
									 <div class="col-md-12">
									<button type="button" name="" class="btn btn-success add_achievement">Add</button>
								</div>
									 <br>
									 <br>
                                 <h3>Please enter Diploma, Certificate details</h3>
 <div class="card sport_card Diploma_Certificate" style="width: 100%;
    float: left;">
					<?php
					 if(!empty($data))
					 {
					$num=count($data['certificate']);
					for($i=0;$i<$num;$i++)
				{
				?>	
				...
				<div class="row">
                       ...
                       <div class="col-md-6">
									<div class="form-row col">
										<div class="col">
											<label><i class="fas fa-circle"></i>Degree/Course, Diploma, Certificate, ete</label>
											<input type="text" value="<?php if(isset($data['certificate'][$i]) && !empty($data['certificate'][$i])) echo $data['certificate'][$i] ?>" class="form-control required" name="certificate[]">
											 <div class="required_error">&nbsp;</div>
										</div>
									</div>
									</div>
									...
									<div class="form-row col">
										<div class="col">
											...
											<input type="text" value="<?php if(isset($data['city_add'][$i]) && !empty($data['city_add'][$i])) echo $data['city_add'][$i] ?>" class="form-control required" name="city_add[]">
											 <div class="required_error">&nbsp;</div>
										</div>
									</div>
									</div>
									...
									<div class="form-row col">
										<div class="col">
											<label><i class="fas fa-circle"></i>Institution/University</label>
											<input type="text" value="<?php if(isset($data['institution'][$i]) && !empty($data['institution'][$i])) echo $data['institution'][$i] ?>" class="form-control required" name="institution[]">
											 <div class="required_error">&nbsp;</div>
										</div>
									</div>
									</div>
				 ...
				 <div class="row">
                       ...
                       <div class="col-md-6">
									<div class="form-row col">
										<div class="col">
											<label><i class="fas fa-circle"></i>Degree/Course, Diploma, Certificate, ete</label>
											<input type="text" value="<?php if(isset($data['certificate']) && !empty($data['certificate'])) echo $data['certificate'] ?>" class="form-control required" name="certificate[]">
											 <div class="required_error">&nbsp;</div>
										</div>
									</div>
									</div>
									...
									<div class="form-row col">
										<div class="col">
											<label><i class="fas fa-circle"></i>City</label>
											<input type="text" value="<?php if(isset($data['city_add']) && !empty($data['city_add'])) echo $data['city_add'] ?>" class="form-control required" name="city_add[]">
											 <div class="required_error">&nbsp;</div>
										</div>
									</div>
									</div>
									...
									<div class="form-row col">
										<div class="col">
											<label><i class="fas fa-circle"></i>Institution/University</label>
											<input type="text" value="<?php if(isset($data['institution']) && !empty($data['institution'])) echo $data['institution'] ?>" class="form-control required" name="institution[]">
											 <div class="required_error">&nbsp;</div>
										</div>
									</div>
									</div>
...
<div class="sport mt-3">
	<h4>Information about the Personal Education Project</h4>
  <div class="card sport_card ">
									...
									<div class="form-row col">
										<div class="col">
											<label><i class="fas fa-circle"></i>Please indicate the exact title of the studies(Ex.Diploma in Sport Science,Cartificate in Coaching,Master in Business Administration,etc.)</label>
											<input type="text" value="<?php if(isset($data['diploma_in'][0]) && !empty($data['diploma_in'][0])) echo $data['diploma_in'][0] ?>" class="form-control required" name="diploma_in[]">
											 <div class="required_error">&nbsp;</div>
										</div>
									</div>
									</div>
									 ...
									 <div class="row">
									  <div class="col-md-12">
                                       <div class="card sport_card">
									<label><i class="fas fa-circle"></i>Description of the education project(seminar,internship,etc.)</label>
									  
										<textarea cols="10" rows="10" name="year_4" class="form-control textarea">{{isset($data['year_4'])? $data['year_4'] : ''}}</textarea>    </div>            
								 </div>
								     </div>
								     <div class="row">                
									...
									<div class="form-row col">
										<div class="col">
											<label><i class="fas fa-circle"></i>Institute</label>
											<input type="text" value="<?php if(isset($data['institute_add'][0]) && !empty($data['institute_add'][0])) echo $data['institute_add'][0] ?>" class="form-control required" name="institute_add[]">
											 <div class="required_error">&nbsp;</div>
										</div>
									</div>
									</div>
									...
									<div class="form-row col">
										<div class="col">
											<label><i class="fas fa-circle"></i>City</label>
											<input type="text" value="<?php if(isset($data['add_city'][0]) && !empty($data['add_city'][0])) echo $data['add_city'][0] ?>" class="form-control required" name="add_city[]">
											 <div class="required_error">&nbsp;</div>
										</div>
									</div>
									</div>
									...
									<div class="form-row col">
										<div class="col">
											<label><i class="fas fa-circle"></i>Country</label>
											<select class="form-control required" name="locations" aria-label="Default select example">
								<option value=""></option>  
								<?php foreach($locations as $vals){ ?>
								<option <?php if(isset($data['locations']) && $data['locations']==$vals) echo 'selected' ?> value="<?php echo $vals ?>"><?php echo $vals ?></option>
								<?php } ?>
									...
									<div class="form-row col">
										<div class="col">
											<label><i class="fas fa-circle"></i>Given Name(s)</label>
											<input type="text" value="<?php if(isset($data['given_name_c'][0]) && !empty($data['given_name_c'][0])) echo $data['given_name_c'][0] ?>" class="form-control required" name="given_name_c[]">
											 <div class="required_error">&nbsp;</div>
										</div>
									</div>
									</div>
									<div class="col-md-4">
										...
										<label><i class="fas fa-circle"></i>Family Name</label>
										<div class="form-group">
											<input type="text" value="<?php if(isset($data['family_name_c'][0]) && !empty($data['family_name_c'][0])) echo $data['family_name_c'][0] ?>" class="form-control required" name="family_name_c[]">
										</div>
									 </div>                         
									...
									<div class="form-row col">
										<div class="col">
											...
											<input type="text" value="<?php if(isset($data['title_c'][0]) && !empty($data['title_c'][0])) echo $data['title_c'][0] ?>" class="form-control required" name="title_c[]">
											 <div class="required_error">&nbsp;</div>
										</div>
									</div>
									</div>
									...
									<div class="form-row col">
										<div class="col">
											<label><i class="fas fa-circle"></i>Personal Email Addresss</label>
											<input type="text" value="<?php if(isset($data['personal_email'][0]) && !empty($data['personal_email'][0])) echo $data['personal_email'][0] ?>" class="form-control required" name="personal_email[]">
											 <div class="required_error">&nbsp;</div>
										</div>
									</div>
									</div>
									...
									<div class="form-row col">
										<div class="col">
											...
											<input type="text" value="<?php if(isset($data['phone_c'][0]) && !empty($data['phone_c'][0])) echo $data['phone_c'][0] ?>" class="form-control required" name="phone_c[]">
											 <div class="required_error">&nbsp;</div>
										</div>
									</div>
									</div>
								 ...
								 <br>
                                    <br>
                                       ...
                                       <h4>Lenght Of Course</h4>
                                       <div class="row">
 
										<div class="col-md-6" style="width: 750px">
									 
											<label><i class="fas fa-circle"></i>Start Date</label>
											<input type="date" value="<?php if(isset($data['s_date'][0]) && !empty($data['s_date'][0])) echo $data['s_date'][0] ?>" class="form-control required" name="s_date[]">
											 <div class="required_error">&nbsp;</div>
											 <div class="required_error">&nbsp;</div>
										</div>
									...
									<div class="col-md-6" style="width: 750px">
										...
										<div class="form-group">
											<input type="date" value="<?php if(isset($data['e_date'][0]) && !empty($data['e_date'][0])) echo $data['e_date'][0] ?>" class="form-control required" name="e_date[]">
											 <div class="required_error">&nbsp;</div>
										</div>
									 </div>                         
...
<table style="margin-top: 20px;">
 ...
 <br>
			...
			<div class="sport">
               ...
               <table style="margin-top: 20px;">
				  ...
				  <br>
					  ...
					  <div class="col">
                                    <input type="radio" id="yes" name="advance_payment" required  value="single" {{isset($data['advance_payment']) && $data['advance_payment']  == "single" ? 'checked' : ''}} >
                                    <label for="male">Yes</label>
                                    <input type="radio" id="no" name="advance_payment" required value="married" {{isset($data['advance_payment']) && $data['advance_payment']  == "married" ? 'checked' : ''}}>
    ...
    var max_fields      = 20;
var wrapper         = $(".achievement"); 
var add_button      = $(".add_achievement");
...
$(add_button).click(function(e){
	...
	if(total_fields < max_fields){
		$(wrapper).append('<div class="row"><div class="col-md-3"><div class="form-row col"><div class="col"> <label><i class="fas fa-circle"></i>Event/Activity/Competition</label> <input type="text"  class="form-control required" name="Competition_date[]"><div class="required_error">&nbsp;</div></div></div></div><div class="col-md-3"><div class="form-row col"><div class="col"> <label><i class="fas fa-circle"></i>Location</label> <input type="text" class="form-control required" name="location[]"><div class="required_error">&nbsp;</div></div></div></div><div class="col-md-3"><div class="form-row col"><div class="col"> <label><i class="fas fa-circle"></i>Date </label> <input type="date"  class="form-control required" name="date[]"><div class="required_error">&nbsp;</div></div></div></div><div class="col-md-3"><div class="form-row col"><div class="col"> <label><i class="fas fa-circle"></i>Result</label> <input type="text"  class="form-control required" name="result[]"><div class="required_error">&nbsp;</div></div></div></div></div>');
		 $('.textarea').summernote();
	}
});
...
$(add_button_d).click(function(e){
	...
	if(total_fields_d < max_fields_d){
		$(wrapper_d).append('<div class="row"><div class="col-md-6"><div class="form-row col"><div class="col"> <label><i class="fas fa-circle"></i>Degree/Course, Diploma, Certificate, ete</label> <input type="text" class="form-control required" name="certificate[]"><div class="required_error">&nbsp;</div></div></div></div><div class="col-md-3"><div class="form-row col"><div class="col"> <label><i class="fas fa-circle"></i>City</label> <input type="text"  class="form-control required" name="city_add[]"><div class="required_error">&nbsp;</div></div></div></div><div class="col-md-3"><div class="form-row col"><div class="col"> <label><i class="fas fa-circle"></i>Institution/University</label><input type="text"class="form-control required" name="institution[]"><div class="required_error">&nbsp;</div></div></div></div></div>');
		 $('.textarea').summernote();
	}
});
