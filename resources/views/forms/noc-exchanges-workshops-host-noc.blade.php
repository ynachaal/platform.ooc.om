...
.budget{
	...
	<section class="content-header">
	   <div class="container-fluid">
		  <div class="row mb-2">
			 <div class="col-sm-6">
				<h1>NOC Exchanges - Workshops - Host NOC</h1>
			 </div>
			 <div class="col-sm-6">
	...
	<section class="content">
			 ...
			 <div class="col-md-12">
				<div class="card card-primary">
				   <div class="card-header">
					  <h3 class="card-title">NOC Exchanges - Workshops - Host NOC</h3>
				   </div>
				   <!-- /.card-header -->
				   <!-- form start -->
				   <form role="form" id="quickForm1" method="POST" action="{{ url('/forms/save_form1') }}" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
						 <div class="form-group col-md-6">
                                <input type="hidden" name="application_id" class="form-control required" placeholder="Committee Name" value="{{$application_id}}">
								 <div class="required_error">&nbsp;</div>
                            </div>
							 <div class="form-group col-md-12">
							  <label></i><i class="fas fa-circle"></i> Activity Name Selection</label>
							   <input type="text" name="activity_name" class="form-control required" placeholder="" value="{{isset($data['activity_name'])? $data['activity_name'] : ''}}">
							  <div class="required_error">&nbsp;</div>
						   </div>
      ...
      <div class="card sport_card">
         <div class="d-md-flex align-items-center">
             <div class="row">
				<div>
					<label style="margin-right: 20px;" for="start_date"><i class="fas fa-circle"></i>Start date</label>
					<input type="date" id="start_date" name="start_date" class="form-control required" style="margin-right: 20px;"  value="{{isset($data['start_date'])? $data['start_date'] : ''}}" >
					<div class="required_error">&nbsp;</div>
				</div>
				<div class="ml-2 mr-2">
					<label style="margin-right: 20px;" for="end_date"><i class="fas fa-circle"></i>End date:</label>
					<input type="date" id="end_date" name="end_date" class="form-control required" style="margin-right: 20px;" value="{{isset($data['end_date'])? $data['end_date'] : ''}}">
					<div class="required_error">&nbsp;</div>
				</div>
			</div>
         </div>
       ...
       <div class="sport mt-3">
		<h3>Noc Initiatives/Activities</h3>
      <div class="card sport_card ">
         <br>
         <p style="color:#1b85c3; margin-bottom:8px;"><b>Exchanges</b>: NOCs wishing to share their knowledge, experience or resources with the NOCs in greatest needshould describe below what and how they wish to shareInternational Workshops: NOCs wishing to organise practical workshops on topics of particular interest to specific </p>
		 
		  <p style="color:#1b85c3; margin-bottom:8px;"><b>International Workshops</b>: NOCs wishing to organise practical workshops on topics of particular interest to specific
			groups of NOCs, which aim to build the capacities of the participating NOCs and their representatives, should
			describe their workshop proposal below. The host NOC will be responsible for the overall organisation and follow-
			up of the workshop, including but not limited to the logistical arrangements, communication with participating
			NOCs and reporting to Olympic Solidarity.    
          </p>
		  
		  <p style="color:#1b85c3; margin-bottom:8px; font-size:18px; font-weight:600;">For national workshops (e.g. for NFs or other internal groups of stakeholders) and bilateral exchanges please use the NOC Management Initiatives application. </p>
		  
		  <p style="margin-bottom:8px;">Please describe the Exchange/Workshop, including the following information:</p>
		  <li>Description of the Exchange/Workshop </li>
		  <li>main objective </li>
		  <li>name of expert/facilitator (if applicable) </li>
		  <li>NOC representative/entity responsible for the subject area </li>
         <div class="sport mt-3">
            
            
		  <p><i class="fas fa-circle"></i>Description</p>
            ...
            <p><i class="fas fa-circle"></i>Why did you choose this particular subject matter?</p>
            <div class="form-group">
			...
			<p><i class="fas fa-circle"></i>Which NOCs/what profile of participants do you intend to invite to the Exchange/Workshop and why? Please provide a list of invitees
			with their functions as they relate to the subject matter (if available)</p>
            <div class="form-group">
			...
			<p><i class="fas fa-circle"></i>Please list the criteria the participants/participating NOCs will need to meet to be able to participate in the Exchange/Workshop.</p>
            <div class="form-group">
			...
			<p><i class="fas fa-circle"></i>Will the participants be expected to make a contribution during the Exchange/Workshop and/or propose an action plan after theExchange/Workshop?</p>
            <div class="form-group">
			...
			<p><i class="fas fa-circle"></i>What are the intended outcomes of the Exchange/ Workshop as they relate to the participating NOC's capacity building ? What will the participants be able to bring to their NOCs?</p>
            <div class="form-group">
 ...
 <div class="card sport_card Diploma_Certificate" id="container" style="width: 100%;
    float: left;">
    <p>Please note that Olympic Solidarity may not cover the total cost of the Exchange/Workshop and provide only a partial contributiontowards its organisation.</p>
