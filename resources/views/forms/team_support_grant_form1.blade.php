							 ...
							 <div class="card sport_card">
								...
								<?php } ?>
									...
									<div class="form-row col">
										<div class="col">
											<label>Season</label>
											<input type="text" class="form-control required" value="{{isset($data['season'])? $data['season'] : ''}}" name="season">
											 <div class="required_error">&nbsp;</div>
								...
								<div class="col-md-6">
									<div class="form-row col">
										<div class="col">
											...
											<input type="text" class="form-control required" value="{{isset($data['event'])? $data['event'] : ''}}" name="event">
											 <div class="required_error">&nbsp;</div>
									...
									<div class="col">
										...
										<div class="col">
											...
											<input type="text" class="form-control required" value="{{isset($data['result'])? $data['result'] : ''}}" name="result">
											 <div class="required_error">&nbsp;</div>
										</div>
									</div>
									</div>
					  ...
					  @endif
						 <div class="sport mt-3">
							<h3>Activities</h3>
							 <div class="card sport_card ">
							 <div class="sport">
							<h3>Objective/Major Competitions</h3>
							 <div class="card sport_card">
								<div class="d-md-flex align-items-center">
								<div class="row">
								<div class="col-md-6">
									...
									<div class="col-md-6">
                                    <label for="exampleInputEmail1">Competition</label>
