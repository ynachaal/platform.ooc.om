		  ...
		  <div class="row mb-2">
			 ...
			 <div class="col-sm-6">
				<ol class="breadcrumb float-sm-right">
				   <li class="breadcrumb-item"><a href="#">Team Support Grant</a></li>
				   <li class="breadcrumb-item active">team-support-grant</li>
				</ol>
			 </div>
		  </div>
	   </div>
			 ...
			 <div class="col-md-12">
				<div class="card card-primary">
				   <div class="card-header">
					  <h3 class="card-title">Team Support Grant</h3>
				   </div>
				   <!-- /.card-header -->
				   <!-- form start -->
				   <form role="form" id="quickForm1" onsubmit="return submit_action();" method="POST" action="{{ url('/forms/save_form1') }}" enctype="multipart/form-data">
					  ...
					  @endif
					  <div class="card-body">
						 <div class="col-md-12 row d-none" style="margin-top: 20px;">
							<div class="form-group col-md-6">
							   <label for="exampleInputEmail1">WBS Number</label>
							   <input type="text" name="wbs_number" class="form-control" placeholder="Enter Wbs Number" value="{{isset($data['wbs_number'])? $data['wbs_number'] : ''}}">
							</div>
						 </div>
						 <input type="hidden" name="application_id" class="form-control" placeholder="Committee Name" value="{{$application_id}}">
						 <div class="form-group col-md-4">
							<label><i class="fas fa-circle"></i> Activites start year for which you wish to request the Team Support Grant</label>
								...
								<div class="d-md-flex align-items-center">
									<div class="form-row col">
										<div class="col">
											...
											<select name="sport" class="form-control required" aria-label="Default select example">
											 <option value=""></option> 
									...
									<div class="form-row col">
										<div class="col">
											<label>Section</label>
											<input  name="section"  value="{{isset($data['section'])? $data['section'] : ''}}" type="text" class="form-control">
											<div class="required_error">&nbsp;</div>
										</div>
									</div>
									<div class="form-row col">
						 ...
						 <div class="sport">
							<h3>Best results - Berif historical summary with result of the team</h3>
							 <div class="card sport_card">
								<div class="d-md-flex align-items-center">
									<div class="form-row col">
										<div class="col">
											<label><i class="fas fa-circle"></i> Event/Activity/Competition Name</label>
									...
									<div class="form-row col">
										<div class="col">
											...
											<input type="date" value="<?php if(isset($data['activity_date'][0]) && !empty($data['activity_date'][0])) echo $data['activity_date'][0] ?>" class="form-control required" name="activity_date[]">
											 <div class="required_error">&nbsp;</div>
										</div>
									</div>
									<div class="form-row col">
										<div class="col">
											<label><i class="fas fa-circle"></i> Territory/Location</label>
											<select class="form-control required" name="activity_location[]" aria-label="Default select example">
												  <option value=""></option>  
												  <?php foreach($locations as $vals){ ?>
												<option <?php if(isset($data['activity_location'][0]) && $data['activity_location'][0]==$vals) echo 'selected' ?> value="<?php echo $vals ?>"><?php echo $vals ?></option>
												<?php } ?>
											</select>
											  <div class="required_error">&nbsp;</div>
										</div>
							...
							<div class="sport_additional"></div>	
							<?php if(isset( $data['activity_name']) && !empty( $data['activity_name'])) { 
							$activity_count = count( $data['activity_name']);
							if($activity_count>1) {
							foreach( $data['activity_name'] as $k=>$v) {
							if($k!=0) {
							?>	
							 <div class="card sport_card sport_php_<?php echo $k ?>">
								<div class="d-md-flex align-items-center">
									<div class="form-row col">
										<div class="col">
											<label><i class="fas fa-circle"></i> Event/Activity/Competition Name</label>
											<input type="text" class="form-control required" value="<?php if(isset($v) && !empty($v)) echo $v; ?>" name="activity_name[]">
											<div class="required_error">&nbsp;</div>
										</div>
									</div>
									<div class="form-row col">
										<div class="col">
											<label><i class="fas fa-circle"></i> Date</label>
											<input type="date" value="<?php if(isset($data['activity_date'][$k]) && !empty($data['activity_date'][$k])) echo $data['activity_date'][$k] ?>" class="form-control required" name="activity_date[]">
											 <div class="required_error">&nbsp;</div>
										</div>
									</div>
									<div class="form-row col">
										<div class="col">
											...
											<select class="form-control required" name="activity_location[]" aria-label="Default select example">
												  <option value=""></option>  
												  <?php foreach($locations as $vals){ ?>
												<option <?php if(isset($data['activity_location'][$k]) && $data['activity_location'][$k]==$vals) echo 'selected' ?> value="<?php echo $vals ?>"><?php echo $vals ?></option>
												<?php } ?>
											</select>
											  <div class="required_error">&nbsp;</div>
										</div>
									...
									<div class="form-row col">
										<div class="col">
											<label><i class="fas fa-circle"></i> Result</label>
											<input type="text" class="form-control required" value="<?php if(isset($data['activity_result'][$k]) && !empty($data['activity_result'][$k])) echo $data['activity_result'][$k] ?>" name="activity_result[]">
											 <div class="required_error">&nbsp;</div>
										</div>
									</div>
								</div>
								 ...
								 <a href="javascript:void(0);" rel="sport_php_<?php echo $k ?>" class="btn btn-danger _btn sport_php_delete">Delete</a>
							 @endif
							 </div>   
							<?php 
							}
					  ...
					  @endif
						 <div class="sport mt-3">
							<h3>Activities</h3>
							 <div class="card sport_card ">
								 <div class="sport">
									<h3>Objectives/Major Competitons</h3>
									 <div class="card sport_card">
										<div class="d-md-flex align-items-center">
											<div class="form-row col">
												<div class="col">
													<label><i class="fas fa-circle"></i> Date</label>
													<input type="date" class="form-control required" value="<?php if(isset($data['objective_date'][0]) && !empty($data['objective_date'][0])) echo $data['objective_date'][0] ?>" name="objective_date[]">
													<div class="required_error">&nbsp;</div>
												</div>
											</div>
											<div class="form-row col">
												<div class="col">
													<label><i class="fas fa-circle"></i> Competition</label>
													<input type="text" value="<?php if(isset($data['objective_competition'][0]) && !empty($data['objective_competition'][0])) echo $data['objective_competition'][0] ?>" class="form-control required" name="objective_competition[]">
													<div class="required_error">&nbsp;</div>
												</div>
											</div>
											<div class="form-row col">
												<div class="col">
													...
													<select class="form-control required" name="objective_location[]" aria-label="Default select example">
													 <option value=""></option> 
													 <?php foreach($locations as $vals){ ?>
												<option <?php if(isset($data['objective_location'][0]) && $data['objective_location'][0]==$vals) echo 'selected' ?> value="<?php echo $vals ?>"><?php echo $vals ?></option>
												<?php } ?>
										...
										<div class="objective_additional"></div>
										
											<?php 
											
											if(isset( $data['objective_date']) && !empty( $data['objective_date'])) { 
											$objective_count = count($data['objective_date']);
											if($objective_count>1){
											foreach( $data['objective_date'] as $k=>$v) {
											if($k!=0) {
										?>	
										<div class="card sport_card object_php_<?php echo $k ?>">
										<div class="d-md-flex align-items-center">
											<div class="form-row col">
												<div class="col">
													<label><i class="fas fa-circle"></i> Date</label>
													<input type="date" class="form-control required" value="<?php if(isset($data['objective_date'][$k]) && !empty($data['objective_date'][$k])) echo $data['objective_date'][$k] ?>" name="objective_date[]">
													<div class="required_error">&nbsp;</div>
												</div>
											</div>
											<div class="form-row col">
												<div class="col">
													<label><i class="fas fa-circle"></i> Competition</label>
													<input type="text" value="<?php if(isset($data['objective_competition'][$k]) && !empty($data['objective_competition'][$k])) echo $data['objective_competition'][$k] ?>" class="form-control required" name="objective_competition[]">
													<div class="required_error">&nbsp;</div>
												</div>
											</div>
											<div class="form-row col">
												<div class="col">
													...
													<select class="form-control required" name="objective_location[]" aria-label="Default select example">
													 <option value=""></option> 
													 <?php foreach($locations as $vals){ ?>
												<option <?php if(isset($data['objective_location'][$k]) && $data['objective_location'][$k]==$vals) echo 'selected' ?> value="<?php echo $vals ?>"><?php echo $vals ?></option>
												<?php } ?>
										...
										@if (( \Auth::user()->hasAnyRole(['User'])) && ((isset($dataUserApplications['status']) &&  $dataUserApplications['status'] == 'not submitted') || !isset($dataUserApplications)))
									 <a href="javascript:void(0);" rel="object_php_<?php echo $k ?>" class="btn btn-danger _btn object_php_delete">Delete</a>
								 @endif
									 </div>
							<?php } } } } ?>
									@if (( \Auth::user()->hasAnyRole(['User'])) && ((isset($dataUserApplications['status']) &&  $dataUserApplications['status'] == 'not submitted') || !isset($dataUserApplications)))
										<a href="javascript:void(0);" class="btn btn-success _btn objective_additional_button">Add</a>			
								@endif									
								</div>
								<br>
								<h4>Year 1 Activites</h4>
								<p>*Year 1 refers to your NOC "activities start year" as noted in the box above</p>
								<p>Percentage of the total budget you wish to dedicate to this year </p>
								<input type="number" class="form-control all_percentage p1" id="p1"  name="year_1_percentage" placeholder="%" value="{{isset($data['year_1_percentage'])? $data['year_1_percentage'] : ''}}">
								<div class="sport mt-3">
									<h3>Brief list of activities that your NOC intends to organise this year in perpartaion of the listed compentitions</h3>
									 <div class="card sport_card">
										<p>Details</p>
								 ...
								 <br>
								<h4>Year 2 Activites</h4>
								<p>Percentage of the total budget you wish to dedicate to this year </p>
								<input type="number" class="form-control all_percentage p2"  id="p2" placeholder="%"  value="{{isset($data['year_2_percentage'])? $data['year_2_percentage'] : ''}}" name="year_2_percentage">
								<div class="sport mt-3">
									<h3>Brief list of activities that your NOC intends to organise this year in perpartaion of the listed compentitions</h3>
									 <div class="card sport_card">
										<p>Details</p>
								 ...
								 <br>
								<h4>Year 3 Activites</h4>
								<p>Percentage of the total budget you wish to dedicate to this year </p>
								<input type="number" class="form-control all_percentage p3"  id="p3" placeholder="%" value="{{isset($data['year_3_percentage'])? $data['year_3_percentage'] : ''}}" name="year_3_percentage">
								<div class="sport mt-3">
									<h3>Brief list of activities that your NOC intends to organise this year in perpartaion of the listed compentitions</h3>
									 <div class="card sport_card">
										<p>Details</p>
								 ...
								 <br>
								<h4>Year 4 Activites</h4>
								<p>Percentage of the total budget you wish to dedicate to this year </p>
								<input type="number" class="form-control all_percentage p4" id="p4" placeholder="%" value="{{isset($data['year_4_percentage'])? $data['year_4_percentage'] : ''}}" name="year_4_percentage">
								<div class="sport mt-3">
									<h3>Brief list of activities that your NOC intends to organise this year in perpartaion of the listed compentitions</h3>
									 <div class="card sport_card">
										<p>Details</p>
								 ...
								 <div class="form-group col-6">
									 <label>Total Activities Percentage%</label>
									 <input type="text" class="form-control result_percentage" value="{{isset($data['result_percentage'])? $data['result_percentage'] : ''}}" name="result_percentage" readonly="true">
								 </div>
								 <p style="display:none" class="text-danger h4 mb-0 TOTAL_100">Total is not 100%</p>
							 </div>
						 </div>
						 <div class="sport mt-3 d-none">
							<h3>Files/Upload/Related Documents</h3>
							 <div class="card sport_card">
								 <p>Upload best results</p>
								 <div class="table-responsive">
									 <table class="table table-sm table-bordered related_div">
										 ...
										 <tbody>
											 <tr>
												 ...
												 <i><input class="related_files" type="file" rel="related_docs" name="attachment[related_docs]"></i>
												 @if(!empty($attachments) && isset($attachments['attachment']) && isset($attachments['attachment']['related_docs']))
														 <a target="_blank" href="{{url('upload/form_document/'.$dataUserApplications['user_id'].'/'.$attachments['attachment']['related_docs'])}}" class="col-md-5 text-center text-dark related_image" ><img src="https://platform.ooc.om/images/pdf-flat.png" class="img-fluid" width="45" height="45"> <?php echo $attachments['attachment']['related_docs'] ?></a>
													 <a  href="javascript:void(0)" rel="related_div" class="col-md-5 text-center text-dark pr-5 pl-5 related_files_php_delete"><i class="fas fa-trash-alt" style="color: red !important;"></i></a>
													 @endif
						 ...
						 <div class="sport mt-3 d-none">
							<h3>Other File Upload</h3>
							 <div class="card sport_card">
								 <div class="d-md-md-flex">
									 <div class="col">
										 <p>Please upload any other document you wish to share</p>
										 <div class="table-responsive other_files0_div">
											 <table class="table table-sm table-bordered">
												 ...
												 <tbody>
													 <tr>
														 ...
														 <i><input type="file" class="other_files_0_input" rel="other_files0" name="attachment[other_files0]"></i> 
														   @if(!empty($attachments) && isset($attachments['attachment']) && isset($attachments['attachment']['other_files0']))
														 <a  target="_blank" href="{{url('upload/form_document/'.$dataUserApplications['user_id'].'/'.$attachments['attachment']['other_files0'])}}" class="col-md-5 text-center text-dark other_files_0_image" ><img src="https://platform.ooc.om/images/pdf-flat.png" class="img-fluid" width="45" height="45"> <?php echo $attachments['attachment']['other_files0'] ?></a>
													 	 <a  href="javascript:void(0)" rel="other_files0_div" class="col-md-5 text-center text-dark pr-5 pl-5 other_files_0_delete"><i class="fas fa-trash-alt" style="color: red !important;"></i></a>
													 @endif
														 </td>
									 ...
									 <div class="col">
										 <div class="form-group">
											 ...
											 <input type="text" value="{{isset($data['other_files_notes'][0])? $data['other_files_notes'][0] : ''}}" class="form-control notes_0" name="other_files_notes[0]">
										 </div>
									 </div>
								 </div>
								 <div class="other_file_additional"></div>
								 <?php 
										/* echo '<pre>';
										print_r($attachments); */
									...
									foreach( $attachments['attachment'] as $k=>$v) {
									if(strstr($k,"other_files")) {
									$replaced = str_replace('other_files','',$k);
									if($replaced!=0){
								?>	
								 <div class="d-md-md-flex other_files_php_<?php echo $k ?> d-none">
									 <div class="col">
											 ...
											 <table class="table table-sm table-bordered">
												 ...
												 <tbody>
													 <tr>
														 ...
														 <i><input type="file" class="other_files" rel="other_files<?php echo $replaced ?>" name="attachment[other_files<?php echo $replaced ?>]"></i>
														 
														 @if(!empty($attachments) && isset($attachments['attachment']) && isset($attachments['attachment']['other_files'.$replaced.'']))
															   <a  target="_blank" href="{{url('upload/form_document/'.$dataUserApplications['user_id'].'/'.$attachments['attachment']['other_files'.$replaced.''])}}" class="col-md-5 text-center text-dark" ><img src="https://platform.ooc.om/images/pdf-flat.png" class="img-fluid" width="45" height="45"> <?php echo $attachments['attachment']['other_files'.$replaced.''] ?></a>
														@endif
														 </td>
									 ...
									 <div class="col">
										 <div class="form-group">
											 <label>File Notes</label>
											 <input type="text" value="{{isset($data['other_files_notes'][$replaced]) ? $data['other_files_notes'][$replaced] : ''}}" class="form-control" name="other_files_notes[]">
										 </div>
									 </div>
									<a href="javascript:void(0);" rel="other_files_php_<?php echo $k ?>" class="btn btn-danger _btn other_files_php_delete">Delete</a>
									
								 </div>
								 <?php 
									}}}}
								 ?>
								 <a style="margin:10px 0 0 0" href="javascript:void(0)" class="btn btn-success _btn other_file_button">Add</a>
							 </div>
						 </div> 	
