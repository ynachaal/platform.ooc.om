				   ...
				   <form role="form" id="quickForm1" method="POST" action="{{ url('/forms/save_form1') }}" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
						 ...
						 <div class="form-group col-md-4">
							<label><i class="fas fa-circle"></i> Activites start year for which you wish to request Continental Athlete Support Grant</label>
                       ...
                       <div class="col-md-3">
									<div class="form-row col">
										<div class="col">
											...
											<input type="text" value="<?php if(isset($data['Competition_date'][0]) && !empty($data['Competition_date'][0])) echo $data['Competition_date'][0] ?>" class="form-control required" name="Competition_date[]">
											 <div class="required_error">&nbsp;</div>
										</div>
									</div>
									</div>
									...
									<div class="form-row col">
										<div class="col">
											...
											<input type="text" value="<?php if(isset($data['location'][0]) && !empty($data['location'][0])) echo $data['location'][0] ?>" class="form-control required" name="location[]">
											 <div class="required_error">&nbsp;</div>
										</div>
									</div>
									</div>
									...
									<div class="form-row col">
										<div class="col">
											...
											<input type="date" value="<?php if(isset($data['date'][0]) && !empty($data['date'][0])) echo $data['date'][0] ?>" class="form-control required" name="date[]">
											 <div class="required_error">&nbsp;</div>
										</div>
									</div>
									</div>
									...
									<div class="form-row col">
										<div class="col">
											...
											<input type="text" value="<?php if(isset($data['result'][0]) && !empty($data['result'][0])) echo $data['result'][0] ?>" class="form-control required" name="result[]">
											 <div class="required_error">&nbsp;</div>
										</div>
									</div>
									</div>
                       ...
                       <div class="col-md-6">
									<div class="form-row col">
										<div class="col">
											...
											<input type="text" value="<?php if(isset($data['certificate'][0]) && !empty($data['certificate'][0])) echo $data['certificate'][0] ?>" class="form-control required" name="certificate[]">
											 <div class="required_error">&nbsp;</div>
										</div>
									</div>
									</div>
									...
									<div class="form-row col">
										<div class="col">
											...
											<input type="text" value="<?php if(isset($data['institution'][0]) && !empty($data['institution'][0])) echo $data['institution'][0] ?>" class="form-control required" name="institution[]">
											 <div class="required_error">&nbsp;</div>
										</div>
									</div>
									</div>
 ...
 <div class="card sport_card" style="width: 100%;
    float: left;">
                       ...
                       <div class="col-md-6">
									<div class="form-row col">
										<div class="col">
											<label><i class="fas fa-circle"></i>Language</label>
											<input type="text" value="<?php if(isset($data['activity_date'][0]) && !empty($data['activity_date'][0])) echo $data['activity_date'][0] ?>" class="form-control required" name="activity_date[]">
											 <div class="required_error">&nbsp;</div>
										</div>
									</div>
									...
									<div class="col-md-12">
                        <label><i class="fas fa-circle"></i>Spoken</label>
                                      </div>
                                    <br>
                                    <div class="col-md-3">
                      <div class="form-check form-check-inline">
  <input class="form-check-input" type="checkbox" id="inlineCheckbox1" name="language_ststus1" value="Beginner" {{isset($data['language_ststus1']) && $data['language_ststus1']  == "Beginner" ? 'checked' : ''}}/>
  <label class="form-check-label" for="inlineCheckbox1">Beginner</label>
</div>
</div>
<div class="col-md-3">
<div class="form-check form-check-inline">
  <input class="form-check-input" type="checkbox" name="language_ststus2" id="inlineCheckbox2" value="Intermediate" {{isset($data['language_ststus2']) && $data['language_ststus2']  == "Intermediate" ? 'checked' : ''}}/>
  <label class="form-check-label" for="inlineCheckbox2">Intermediate</label>
</div> 
</div>
<div class="col-md-3">
<div class="form-check form-check-inline">
  <input class="form-check-input" type="checkbox" name="language_ststus34" id="inlineCheckbox2" value="Advanced" {{isset($data['language_ststus34']) && $data['language_ststus34']  == "Advanced" ? 'checked' : ''}}/>
  <label class="form-check-label" for="inlineCheckbox2">Advanced</label>
</div>
</div>
<div class="col-md-3">
<div class="form-check form-check-inline">
  <input class="form-check-input" type="checkbox" name="language_ststus4" id="inlineCheckbox2" value="Fluent" {{isset($data['language_ststus4']) && $data['language_ststus4']  == "Fluent" ? 'checked' : ''}}/>
  <label class="form-check-label" for="inlineCheckbox2">Fluent</label>
</div>
</div>
 <br>
 <br>
 <div class="col-md-12">
                        <label><i class="fas fa-circle"></i>Witten</label>
                                      </div>
                                    <br>
                                    <div class="col-md-3">
                      <div class="form-check form-check-inline">
  <input class="form-check-input" type="checkbox" id="inlineCheckbox1" name="language_ststus5" value="Beginner" {{isset($data['language_ststus5']) && $data['language_ststus5']  == "Beginner" ? 'checked' : ''}}/>
  <label class="form-check-label" for="inlineCheckbox1">Beginner</label>
</div>
</div> 
<div class="col-md-3">
<div class="form-check form-check-inline">
  <input class="form-check-input" type="checkbox" id="inlineCheckbox2" name="language_ststus6" value="Intermediate" {{isset($data['language_ststus6']) && $data['language_ststus6']  == "Intermediate" ? 'checked' : ''}}/>
  <label class="form-check-label" for="inlineCheckbox2">Intermediate</label>
</div>
</div>
<div class="col-md-3">
<div class="form-check form-check-inline">
  <input class="form-check-input" type="checkbox" name="language_ststus7" id="inlineCheckbox2" value="Advanced" {{isset($data['language_ststus7']) && $data['language_ststus7']  == "Advanced" ? 'checked' : ''}}/>
  <label class="form-check-label" for="inlineCheckbox2">Advanced</label>
</div>
</div>
<div class="col-md-3">
<div class="form-check form-check-inline">
  <input class="form-check-input" type="checkbox" name="language_ststus8" id="inlineCheckbox2" value="Fluent" {{isset($data['language_ststus8']) && $data['language_ststus8']  == "Fluent" ? 'checked' : ''}}/>
  <label class="form-check-label" for="inlineCheckbox2">Fluent</label>
</div> 
</div>
 <br>
 <br>
 <div class="col-md-12">
                        <label><i class="fas fa-circle"></i>Read</label>
                                      </div>
                                    <br>
                                    <div class="col-md-3">
                      <div class="form-check form-check-inline">
  <input class="form-check-input" type="checkbox" id="inlineCheckbox1" name="language_ststus9" value="Beginner" {{isset($data['language_ststus9']) && $data['language_ststus9']  == "Beginner" ? 'checked' : ''}}/>
  <label class="form-check-label" for="inlineCheckbox1">Beginner</label>
</div>
</div>
<div class="col-md-3">
<div class="form-check form-check-inline">
  <input class="form-check-input" type="checkbox" id="inlineCheckbox2" name="language_ststus10" value="Intermediate" {{isset($data['language_ststus10']) && $data['language_ststus10']  == "Intermediate" ? 'checked' : ''}}/>
  <label class="form-check-label" for="inlineCheckbox2">Intermediate</label>
</div>
</div>
<div class="col-md-3">
<div class="form-check form-check-inline">
  <input class="form-check-input" type="checkbox" id="inlineCheckbox2" name="language_ststus11" value="Advanced" {{isset($data['language_ststus11']) && $data['language_ststus11']  == "Advanced" ? 'checked' : ''}}/>
  <label class="form-check-label" for="inlineCheckbox2">Advanced</label>
</div>
</div>
<div class="col-md-3">
<div class="form-check form-check-inline">
  <input class="form-check-input" type="checkbox" id="inlineCheckbox2" name="language_ststus12" value="Fluent" {{isset($data['language_ststus12']) && $data['language_ststus12']  == "Fluent" ? 'checked' : ''}}/>
  <label class="form-check-label" for="inlineCheckbox2">Fluent</label>
</div>
</div>
</div>
							...
							<h3>Budget Proposal</h3>
							 <div class="card sport_card">
								...
								<div class="row">
									...
									<div class="form-row col">
										<div class="col">
											<label><i class="fas fa-circle"></i>Amount</label>
											<input type="text" value="<?php if(isset($data['activity_date'][0]) && !empty($data['activity_date'][0])) echo $data['activity_date'][0] ?>" class="form-control required" name="activity_date[]">
											 <div class="required_error">&nbsp;</div>
										</div>
									</div>
                                    ...
                                    <div class="col-md-12">
									<button type="button" name="" class="btn btn-success">Add Item</button>
								</div>
									 <br>
									 <br>
									<div class="col-md-6">
									<div class="form-row col">
										<div class="col">
											...
											<input type="text" value="<?php if(isset($data['activity_date'][0]) && !empty($data['activity_date'][0])) echo $data['activity_date'][0] ?>" class="form-control required" name="activity_date[]" placeholder="0">
											 <div class="required_error">&nbsp;</div>
										</div>
									</div>
									</div>
							 ...
							 <br>
                                   <div class="row">
                                    <div class="col-md-12">
                        <label><i class="fas fa-circle"></i>Request 75% advance payment</label>
                                      </div>
                                    <br>
                                    <div class="col-md-3">
                      <div class="form-check form-check-inline">
