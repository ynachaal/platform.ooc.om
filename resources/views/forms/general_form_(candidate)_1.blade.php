                ...
                <div class="card card-primary">
                    ...
                    <form role="form" id="quickForm1" method="POST" action="{{ url('/forms/save_form1') }}" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            ...
                            <div id="form_header_2" class="form-group col-md-12">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <input type="text" id="email" name="email" class="form-control" placeholder="البريـــــــد الالكترونــــــي" value="{{isset($data['email'])? $data['email'] : ''}}">
                            ...
                            <table style="margin-top: 20px;">
                                ...
                                <tr>
                                    <td class="p-0"><input type="text" name="year[2]" class="form-control border-0"  value="{{isset($data['year'][2])? $data['year'][2] : ''}}"></td>
                                    <td class="p-0"><input type="text" name="qualification[2]" class="form-control border-0"  value="{{isset($data['qualification'][2])? $data['qualification'][2] : ''}}"></td>
                                    <td class="p-0"><input type="text" name="enterprise[2]" class="form-control border-0"  value="{{isset($data['enterprise'][2])? $data['enterprise'][2] : ''}}"></td>
                                </tr>
                                <tr>
                                    <td class="p-0"><input type="text" name="year[3]" class="form-control border-0"  value="{{isset($data['year'][3])? $data['year'][3] : ''}}"></td>
                                    <td class="p-0"><input type="text" name="qualification[3]" class="form-control border-0"  value="{{isset($data['qualification'][3])? $data['qualification'][3] : ''}}"></td>
                                    <td class="p-0"><input type="text" name="enterprise[3]" class="form-control border-0"  value="{{isset($data['enterprise'][3])? $data['enterprise'][3] : ''}}"></td>
                                </tr>
                            </table>
                            ...
                            <table style="margin-top: 20px;">
                                ...
                                <tr>
                                    <td class="p-0"><input type="text" name="sports_year[2]" class="form-control border-0"  value="{{isset($data['sports_year'][2])? $data['sports_year'][2] : ''}}"></td>
                                    <td class="p-0"><input type="text" name="experience[2]" class="form-control border-0"  value="{{isset($data['experience'][2])? $data['experience'][2] : ''}}"></td>
                                    <td class="p-0"><input type="text" name="sports_enterprise[2]" class="form-control border-0"  value="{{isset($data['sports_enterprise'][2])? $data['sports_enterprise'][2] : ''}}"></td>
                                </tr>
                                <tr>
                                    <td class="p-0"><input type="text" name="sports_year[3]" class="form-control border-0"  value="{{isset($data['sports_year'][3])? $data['sports_year'][3] : ''}}"></td>
                                    <td class="p-0"><input type="text" name="experience[3]" class="form-control border-0"  value="{{isset($data['experience'][3])? $data['experience'][3] : ''}}"></td>
                                    <td class="p-0"><input type="text" name="sports_enterprise[3]" class="form-control border-0"  value="{{isset($data['sports_enterprise'][3])? $data['sports_enterprise'][3] : ''}}"></td>
                                </tr>
                            </table>
