	...
	//print_r($data['proposed_activity']);die();
...
.budget{
	...
	<section class="content-header">
	   <div class="container-fluid">
		  <div class="row mb-2">
			 <div class="col-sm-6">
				<h1>Olympic Scholarships for Athletes - Beijing 2022 - Tailor-Made</h1>
			 </div>
			 <div class="col-sm-6">
			 ...
			 <div class="col-md-12">
				<div class="card card-primary">
				   <div class="card-header">
					  <h3 class="card-title">Olympic Scholarships for Athletes - Beijing 2022 - Tailor-Made</h3>
				   </div>
				   <!-- /.card-header -->
				   <!-- form start -->
				   <br>
				   <h3 style="color: #007bff;font-weight: 550;">Personal Details</h3>
				   <div class="card   Diploma_Certificate" style="width: 98%;float: left;margin: 0px;padding: 4px;"></div>
				   <br>
				   <h3 style="color: #007bff;font-weight: 550;">Sport Selection</h3>
				   <div class="card   Diploma_Certificate" style="width: 98%;float: left;margin: 0px;padding: 4px;"></div>
				   <br>
				   <form role="form" id="quickForm1" method="POST" action="{{ url('/forms/save_form1') }}" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                        	<h3 style="color: #007bff;font-weight: 550;">Activity - For each activity/project, please provide the following information</h3>
						 <div class="form-group col-md-6">
							 ...
							 if(!empty($data))
							 {
							$num=count($data['proposed_activity']);
							for($i=0;$i<$num;$i++)
						{
						?>	
							...
							<div class="card sport_card ">
								...
								<div class="col">
								<p><i class="fas fa-circle"></i>Proposed Activity</p>
								<input type="text"   name="proposed_activity[]" class="form-control required" placeholder="Proposed Activity" value="<?php if(isset($data['proposed_activity'][$i]) && !empty($data['proposed_activity'][$i])) echo $data['proposed_activity'][$i] ?>">
								<div class="required_error">&nbsp;</div>
								</div>
								<div class="col">
									<p><i class="fas fa-circle"></i>Objective and description(including date and locations) of the proposed activity</p>
											<textarea cols="10" rows="10" name="year_1[]" class="form-control required textarea"><?php if(isset($data['year_1'][$i]) && !empty($data['year_1'][$i])) echo $data['year_1'][$i] ?></textarea>
											<div class="required_error">&nbsp;</div>     
								</div>
							</div>
							 <?php }} else { ?>	
							...
							<div class="card sport_card ">
								<div class="col">
								<p><i class="fas fa-circle"></i>Proposed Activity</p>
								<input type="text"   name="proposed_activity[]" class="form-control required" placeholder="Proposed Activity" value="{{isset($data['proposed_activity'])? $data['proposed_activity'] : ''}}">
								<div class="required_error">&nbsp;</div>
								</div>
								   ...
								   <div class="col">
									<p><i class="fas fa-circle"></i>Objective and description(including date and locations) of the proposed activity</p>
											<textarea cols="10" rows="10" name="year_1[]" class="form-control required textarea">{{isset($data['year_1'])? $data['year_1'] : ''}}</textarea>
											<div class="required_error">&nbsp;</div>     
								</div>
								</div>
							 <?php } ?>								
								...
								<div class="col-md-12">
									<button type="button" name="" class="btn btn-success add_field_button">Add Activity</button>
								</div><br><br><br>
...
$(add_button).click(function(e){
	...
	if(total_fields < max_fields){
		$(wrapper).append('<div class="card sport_card "><div class="col"><p><i class="fas fa-circle"></i>Proposed Activity</p><input type="text"   name="proposed_activity[]" class="form-control required" placeholder="Proposed Activity"><div class="required_error">&nbsp;</div></div> <div class="col"><p><i class="fas fa-circle"></i>Objective and description(including date and locations) of the proposed activity</p><textarea cols="10" rows="10" name="year_1[]" class="form-control required textarea"></textarea><div class="required_error">&nbsp;</div></div></div>');
$('.textarea').summernote();
	}
});
