	...
	$edition = array('XXIV EN(2021-2022)'=>'XXIV EN(2021-2022)','XXV EN(2022-2023)'=>'XXV EN(2022-2023)','XXVI EN(2023-2024)'=>'XXVI EN(2023-2024)','XXVI EN(2024-2025)'=>'XXVI EN(2024-2025)','IX FR(2021-2022)'=>'IX FR(2021-2022)'   ,'X FR(2023-2024)'=>'X FR(2023-2024)','IX ES(2022-2023)'=>'IX ES(2022-2023)','X ES(2024-2025)'=>'X ES(2024-2025)');
	$language = array('English'=>'English','French'=>'French','Spanish'=>'Spanish');
...
.budget{
	...
	<section class="content-header">
	   <div class="container-fluid">
		  <div class="row mb-2">
			 <div class="col-sm-6">
				<h1>International Executive Courses in Sports Management - MEMOS</h1>
			 </div>
			 <div class="col-sm-6">
			 ...
			 <div class="col-md-12">
				<div class="card card-primary">
				   <div class="card-header">
					  <h3 class="card-title">International Executive Courses in Sports Management - MEMOS</h3>
				   </div>
				   <!-- /.card-header -->
				   <!-- form start -->
							...
							<h3>MEMOS details</h3>
							 <div class="card sport_card">
									...
									<div class="form-row col">
										<div class="col">
                                           <div class="col">
											...
											<select class="form-control required" name="language" aria-label="Default select example">
											<option value=""></option>  
											<?php foreach($language as $vals){ ?>
											<option <?php if(isset($data['language']) && $data['language']==$vals) echo 'selected' ?> value="<?php echo $vals ?>"><?php echo $vals ?></option>
											<?php } ?>
										</select>
											<div class="required_error">&nbsp;</div>
										</div>
											...
											<!-- <label><i class="fas fa-circle"></i>Language</label>
											<input type="text" name="language" class="form-control required" placeholder="Language" value="{{isset($data['language'])? $data['language'] : ''}}">
											<div class="required_error">&nbsp;</div> -->
										</div>
									</div>
								</div>
								...
								<div class="col-md-6">
									<div class="form-row col">
										<div class="col">
											<label><i class="fas fa-circle"></i>Edition</label>
											<select class="form-control required" name="edition" aria-label="Default select example">
											<option value=""></option>  
											<?php foreach($edition as $vals){ ?>
											<option <?php if(isset($data['edition']) && $data['edition']==$vals) echo 'selected' ?> value="<?php echo $vals ?>"><?php echo $vals ?></option>
											<?php } ?>
										</select>
											<div class="required_error">&nbsp;</div>
										</div>
								...
								<br>
									<div class="d-md-flex align-items-center">
										<div class="form-row col">
										<div class="col">
											<label><i class="fas fa-circle"></i>Proposed MEMOS project topic</label>
											<div class="form-group">
											<textarea cols="10" rows="5" name="p1" class="form-control  required">{{isset($data['p1'])? $data['p1'] : ''}}</textarea>
											<div class="required_error">&nbsp;</div>
											</div>
									...
									<div class="d-md-flex align-items-center">
										...
										<div class="col">
											...
											<div class="form-group">
											<textarea cols="10" rows="5" name="p2" class="form-control  required">{{isset($data['p2'])? $data['p2'] : ''}}</textarea>
											<div class="required_error">&nbsp;</div>
											</div>
									...
									<div class="d-md-flex align-items-center">
										<div class="form-row col">
										<div class="col">
											<label><i class="fas fa-circle"></i>How will your NOC and/or your candidate's organisation improve due to his or her potential participation in MEMOS?</label>
											<div class="form-group">
											<textarea cols="10" rows="5" name="p3" class="form-control  required">{{isset($data['p3'])? $data['p3'] : ''}}</textarea>
											<div class="required_error">&nbsp;</div>
											</div>
										</div>
									</div>
									...
									<div class="d-md-flex align-items-center">
										<div class="form-row col">
										<div class="col">
											<label><i class="fas fa-circle"></i>Please explain the relevance of the project and its importance to your NOC and/or the candidate's organisation.</label>
											<div class="form-group">
											<textarea cols="10" rows="5" name="p4" class="form-control  required">{{isset($data['p4'])? $data['p4'] : ''}}</textarea>
											<div class="required_error">&nbsp;</div>
											</div>
										</div>
									</div>
									...
									<div class="d-md-flex align-items-center">
										<div class="form-row col">
										<div class="col">
											<label><i class="fas fa-circle"></i>Does the candidate have a mandate to implement his or her project after completion of MEMOS and what are the chances of its implementation? How will your NOC support the implementation of the project?</label>
											<textarea cols="10" rows="5" name="p5" class="form-control  required">{{isset($data['p5'])? $data['p5'] : ''}}</textarea>
											<div class="required_error">&nbsp;</div>
										</div>
									</div>
									</div>
...
Who will be responsible for covering the costs related to your candidate's potential participation in MEMOS that are not covered by the OS scholarship?</label>
											<textarea cols="10" rows="5" name="p6" class="form-control  required">{{isset($data['p6'])? $data['p6'] : ''}}</textarea>
											<div class="required_error">&nbsp;</div>
										</div>
									</div>
									</div>
								<div class="d-md-flex align-items-center">
										...
										<div class="col">
											<label><i class="fas fa-circle"></i>
Will your candidate be available to take part in all four modules during the 12 months of the course, as required in order to successfully complete the programme?</label>
											<div class="col">
