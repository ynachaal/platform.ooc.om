...
$activity_name = array('Cologne University(Germany)-Master In Olympic'=>'Cologne University(Germany)-Master In Olympic','IOA/University of Peloponnese(Greece)-Master in Olympic Studies'=>'IOA/University of Peloponnese(Greece)-Master in Olympic Studies','IOC Diploma in Sports Medicine(Distance Learning)'=>'IOC Diploma in Sports Medicine(Distance Learning)','IOC Diploma in Physical Therapies(Distance Learning)'=>'IOC Diploma in Physical Therapies(Distance Learning)','IOC Diploma in Sports Nutrition(Distance Learning)'=>'IOC Diploma in Sports Nutrition(Distance Learning)','IOC Diploma in Mental Health in Elite Sport(Distance Learning)'=>'IOC Diploma in Mental Health in Elite Sport(Distance Learning)','IOC Certificate in Drugs in Sport(Distance Learning)'=>'IOC Certificate in Drugs in Sport(Distance Learning)','IOC World Conference on Prevention of Injury and Illness in Sport Womens Sport Leadership Academy'=>'IOC World Conference on Prevention of Injury and Illness in Sport Womens Sport Leadership Academy','IOC Certificate: Safeguarding Officer in Sport'=>'IOC Certificate: Safeguarding Officer in Sport','Other'=>'Other');
...
.budget{
			 ...
			 <div class="col-md-12">
				<div class="card card-primary">
				   <div class="card-header">
					  <h3 class="card-title">Olympic Values - Training</h3>
				   </div>
				   <!-- /.card-header -->
				   <!-- form start -->
   ...
   <div class="form-group col-md-4">
      <label></i> Activity Name Selection</label>
     <div class="col">
		<select  name="activity_name"  class="form-control required" aria-label="Default select example">
			  <option value=""></option> 
			  <?php foreach($activity_name as $vals){ ?>
			<option <?php if(isset($data['activity_name']) && $data['activity_name']==$vals) echo 'selected' ?> value="<?php echo $vals ?>"><?php echo $vals ?></option>
			<?php } ?>
		</select>
            ...
            <div class="row">
               ...
               <div class="col-md-3">
                  <div class="form-row col">
                     <div class="col">
                        <div class="text">
                           <h5 style="font-weight:700; font-size:16px;">Olympian</h5>
                        </div>
						<input type="radio" id="yes" name="olympian" required  value="single" {{isset($data['olympian']) && $data['olympian']  == "single" ? 'checked' : ''}} >
						<label for="male">Yes</label>
						<input type="radio" id="no" name="olympian" required value="married" {{isset($data['olympian']) && $data['olympian']  == "married" ? 'checked' : ''}}>
   ...
   <div class="sport mt-3">
      <div class="card sport_card ">
         <br>
         <h4></h4>
         <p>Does the Candidate collaborate closely with your NOC?</p>
         <div class="col">
            <input type="radio" id="yes" name="noc1"  value="single" required {{isset($data['noc1']) && $data['noc1']  == "single" ? 'checked' : ''}} >
						<label for="male">Yes</label>
						<input type="radio" id="no" name="noc1" required value="married" {{isset($data['noc1']) && $data['noc1']  == "married" ? 'checked' : ''}}>
						<label for="female">NO</label>
         </div>
         <div class="sport mt-3">
            <div class="card sport_card">
               <p><i class="fas fa-circle"></i>Please briefly explain the background of your NOC’s candidate and how attendance at the requested training programme will Benefit him/her.</p>
            ...
            <br>
            <h4></h4>
            <p><i class="fas fa-circle"></i>Please briefly explain how your candidate's participation in this training programme will bring added value to your NOC or to your sporting
               ‘community 
            </p>
            <div class="form-group">
            ...
            <div class="sport mt-3">
               <div class="card sport_card">
                  <p><i class="fas fa-circle"></i>Once the training has been completed, will your candidate train or share knowledge with other people in your sporting community?</p>
                  <div class="col">
                     	<input type="radio" id="yes" name="share_knowledge" required  value="single" {{isset($data['share_knowledge']) && $data['share_knowledge']  == "single" ? 'checked' : ''}} >
						<label for="male">Yes</label>
						<input type="radio" id="no" name="share_knowledge" required value="married" {{isset($data['share_knowledge']) && $data['share_knowledge']  == "married" ? 'checked' : ''}}>
						<label for="female">NO</label>
                  </div>
               </div>
            </div>
 ...
 <div class="card sport_card Diploma_Certificate" id="container" style="width: 100%;
    float: left;">
    <p>Please indicate estimated costs if there are any other expenses besides the tuition fees. In case there is no budget to request,
    please add in the mandatory field "No budget with a 0 in the amount.</p>
