...
.budget{
	...
	<section class="content-header">
	   <div class="container-fluid">
		  <div class="row mb-2">
			 <div class="col-sm-6">
				<h1>Athlete Career Transition - Athletes Education - Athlete 365 Business Accelerator</h1>
			 </div>
			 <div class="col-sm-6">
				<ol class="breadcrumb float-sm-right">
				   <li class="breadcrumb-item"><a href="#">Home</a></li>
				   <li class="breadcrumb-item active">Athlete Career Transition - Athletes Education - Athlete 365 Business Accelerator</li>
				</ol>
			 </div>
		  </div>
	   </div>
			 ...
			 <div class="col-md-12">
				<div class="card card-primary">
				   <div class="card-header">
					  <h3 class="card-title">Athlete Career Transition - Athletes Education - Athlete 365 Business Accelerator</h3>
				   </div>
				   <!-- /.card-header -->
				   <!-- form start -->
   ...
   <input class="form-check-input" type="checkbox" id="inlineCheckbox1" name="active1" value="Yes" {{isset($data['active1']) && $data['active1']  == "Yes" ? 'checked' : ''}}/>
  <label class="form-check-label" for="inlineCheckbox1">Active</label>
</div>
</div>
<div class="col-md-4">
<div class="form-check form-check-inline">
  <input class="form-check-input" type="checkbox" id="inlineCheckbox1" name="2_years" value="Yes" {{isset($data['2_years']) && $data['2_years']  == "Yes" ? 'checked' : ''}}/>
  <label class="form-check-label" for="inlineCheckbox2">Retirement foreseen within the next 2 years</label>
</div>
</div>
<div class="col-md-4">
<div class="form-check form-check-inline">
  <input class="form-check-input" type="checkbox" id="inlineCheckbox1" name="retired" value="Yes" {{isset($data['retired']) && $data['retired']  == "Yes" ? 'checked' : ''}}/>
...
<br>
                       ...
                       <div class="col-md-6">
									<div class="form-row col">
										<div class="col">
											...
											<select class="form-control required" name="games" aria-label="Default select example">
								<option value=""></option>  
								<?php foreach($games as $vals){ ?>
								<option <?php if(isset($data['games']) && $data['games']==$vals) echo 'selected' ?> value="<?php echo $vals ?>"><?php echo $vals ?></option>
								<?php } ?>
							</select>
											 <div class="required_error">&nbsp;</div>
										</div>
 ...
 <br>
               ...
               <div class="card sport_card add_more_show" id='container' style="width: 100%;
    float: left;">
    <h3>Detailed breakdown of budget requested from Olympic Solidarity </h3>
				...
				<?php } ?>
									 ...
									 <div class="col-md-12">
									<button type="button" name="" class="btn btn-success add_more_show_button">Add</button>
								</div>
									 <br>		 
						...
						<div class="col-md-6">
									<div class="form-row col">
										<div class="col">
											...
											<input type="text" value="" placeholder="0" class="form-control required"  id="totalSum" name="total">
											 <div class="required_error">&nbsp;</div>
										</div>
									</div>
									</div>
...
var wrapper_d1         = $(".add_more_show"); 


var add_button_d1      = $(".add_more_show_button");
