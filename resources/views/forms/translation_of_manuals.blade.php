	...
	$manual_translate = array('Managing Olympic Sport Organisations'=>'Managing Olympic Sport Organisations','Sports Administration Manual'=>'Sports Administration Manual');
...
.budget{
	...
	<section class="content-header">
	   <div class="container-fluid">
		  <div class="row mb-2">
			 <div class="col-sm-6">
				<h1>National Courses for Sports Administrators - Translation of Manuals</h1>
			 </div>
			 <div class="col-sm-6">
			 ...
			 <div class="col-md-12">
				<div class="card card-primary">
				   <div class="card-header">
					  <h3 class="card-title">National Courses for Sports Administrators - Translation of Manuals</h3>
				   </div>
				   <!-- /.card-header -->
				   <!-- form start -->
				   <form role="form" id="quickForm1" method="POST" action="{{ url('/forms/save_form1') }}" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
						 <div class="form-group col-md-6">
                            ...
                            <div class="sport">
							<h3>Estimated Dates of Translation</h3>
								...
								<div class="d-md-flex align-items-center">
									...
									<div class="form-row col">
										<div class="col">
											...
											<input type="date" name="start_date" class="form-control required" placeholder="Enter date" value="{{isset($data['start_date'])? $data['start_date'] : ''}}">
									...
									<div class="form-row col">
										<div class="col">
											...
											<input type="date" name="end_date" class="form-control required" placeholder="Enter date" value="{{isset($data['end_date'])? $data['end_date'] : ''}}">
											<div class="required_error">&nbsp;</div>
										</div>
									</div>
									</div>
							...
							<h3>Manual Information</h3>
							 <div class="card sport_card">
								...
								<div class="col-md-6">
									<div class="form-row col">
										<div class="col">
											<label><i class="fas fa-circle"></i>Which manual do you wish to translate?</label>
											<select class="form-control required" name="support_grant" aria-label="Default select example">
								<option value=""></option>  
								<?php foreach($manual_translate as $vals){ ?>
								...
								<?php } ?>
									...
									<div class="col-md-6">
										<div class="col">
											<label><i class="fas fa-circle"></i> Into Which language do you wish to translate the manual?</label>
												<input type="text" class="form-control required" value="{{isset($data['language_name'])? $data['language_name'] : ''}}" name="language_name">
									...
									<div class="col-md-12">
										...
										<div class="col">
											<label><i class="fas fa-circle"></i>who will translate the manual? What are the translator's qualifications?</label>
									...
									<div class="col-md-12">
										<div class="col">
											<label><i class="fas fa-circle"></i>Who will proofred the translation of the manual?</label>
											
											<textarea rows="4" class="form-control required" name="translator_proofred">{{isset($data['translator_proofred'])?$data['translator_proofred']: ''}}</textarea>
											 <div class="required_error">&nbsp;</div>
									...
									<div class="col-md-12">
										<div class="col">
											<label><i class="fas fa-circle"></i>Do you also intend to print the manual? How many copies?</label>
											
											<textarea rows="4" class="form-control required" name="no_copies">{{isset($data['no_copies'])?$data['no_copies']: ''}}</textarea>
											 <div class="required_error">&nbsp;</div>
...
$('#container').change(function(e){
    ...
    $('#totalSum').val(sum);
			   ...
			   <div class="sport">
							<h3>Confirmation</h3>
							<p>Befor confirming your NOC's agreement, you must read the conditions for Olympic Solidarity approval of your request and your NOC's copying obligations. <br> On behalf of the NOC I confirm that NOC agree to comply with the following stipulations should olympic solidarity grant its approval to translate the above mentioned manual:</p>
							 <div class="card sport_card">
								<div class="d-md-flex align-items-center">
								<div class="row">
								<div class="col-md-1">
									 <input class="form-check-input" type="checkbox" name="option" id="inlineCheckbox2" value="option" {{isset($data['option']) && $data['option']  == "option" ? 'checked' : ''}}/>
								</div>
								<div class="col-md-11">
									<p>Accept responsibility for the quality of the translation and proofreading</p>
								</div>
								<div class="col-md-1">
									 <input class="form-check-input" type="checkbox" name="option2" id="inlineCheckbox2" value="option2" {{isset($data['option2']) && $data['option2']  == "option2" ? 'checked' : ''}}/>
								</div>
								<div class="col-md-11">
									<p>Acquire consent of the corresponding photographer or organisation to use any photographs, logos and symbols other than those contained in the original version of the manual.</p>
								</div>
								<div class="col-md-1">
									 <input class="form-check-input" type="checkbox" name="option3" id="inlineCheckbox2" value="option3" {{isset($data['option3']) && $data['option3']  == "option3" ? 'checked' : ''}}/>
								</div>
								<div class="col-md-11">
									<p>Ensur Olympic symbols are used in strict accordance with the Olympic Charter and the related regulations.</p>
								</div>
								<div class="col-md-1">
									 <input class="form-check-input" type="checkbox" name="option4" id="inlineCheckbox2" value="option4" {{isset($data['option4']) && $data['option4']  == "option4" ? 'checked' : ''}}/>
								</div>
								<div class="col-md-11">
									<p>Observe the manual cpoyright in the name of Olympic solidarity ans the IOC and respect the ownership by the IOC.</p>
								</div>
									<div class="col-md-1">
									 <input class="form-check-input" type="checkbox" name="option5" id="inlineCheckbox2" value="option5" {{isset($data['option5']) && $data['option5']  == "option5" ? 'checked' : ''}}/>
								</div>
								<div class="col-md-11">
									<p>Translate into the language of the manual and clearly at the beginning of the translated manual the disclaimer containing the names of the authors of the original manual (as specified in the conditions for Olympic Solidarity approval.))</p>
								</div>
									<div class="col-md-1">
									 <input class="form-check-input" type="checkbox" name="option6" id="inlineCheckbox2" value="option6" {{isset($data['option6']) && $data['option6']  == "option6" ? 'checked' : ''}}/>
								</div>
								<div class="col-md-11">
									<p>Consent to Olympic Solidarity's Sharing of the translated version of the manual with other NOCs.</p>
								</div>
