...
.budget{
	...
	<section class="content-header">
	   <div class="container-fluid">
		  <div class="row mb-2">
			 <div class="col-sm-6">
				<h1>National Courses for Sports Administrators - Sports Administrators Courses</h1>
			 </div>
			 <div class="col-sm-6">
			 ...
			 <div class="col-md-12">
				<div class="card card-primary">
				   <div class="card-header">
					  <h3 class="card-title">National Courses for Sports Administrators - Sports Administrators Courses</h3>
				   </div>
				   <!-- /.card-header -->
				   <!-- form start -->
				   <form role="form" id="quickForm1" method="POST" action="{{ url('/forms/save_form1') }}" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
						 <div class="form-group col-md-6">
                            ...
                            <div class="sport">
							<h3>Indicative Start and End Dates</h3>
								...
								<div class="d-md-flex align-items-center">
									...
									<div class="form-row col">
										<div class="col">
											...
											<input type="date" value="{{isset($data['dob'])?$data['dob'] : ''}}" name="dob" class="form-control required">
...
<div class="col-md-3">
									<div class="form-row col">
                      <div class="form-check form-check-inline">
  <input class="form-check-input" type="checkbox" id="inlineCheckbox1" name="online" value="Active" {{isset($data['online']) && $data['online']  == "Active" ? 'checked' : ''}} />
								...
								<div class="col-md-6">
									...
									<div class="form-row col">
										<div class="col">
											...
											<input type="text" class="form-control" name="estimated" value="{{isset($data['estimated'])?$data['estimated']:''}}">
											<div class="required_error">&nbsp;</div>
										</div>
									</div>
									</div>
								...
								<div class="d-md-flex align-items-center">
									...
									<div class="form-row col">
										<div class="col">
											...
											<input type="text" class="form-control" name="english_number" value="{{isset($data['english_number'])?$data['english_number']:''}}">
											<div class="required_error">&nbsp;</div>
										</div>
									</div>
									</div>
									...
									<div class="form-row col">
										<div class="col">
											...
											<input type="text" class="form-control" name="french_number" value="{{isset($data['french_number'])?$data['french_number']:''}}">
											<div class="required_error">&nbsp;</div>
										</div>
									</div>
									</div>
									...
									<div class="form-row col">
										<div class="col">
											...
											<input type="text" class="form-control" name="spanish_number" value="{{isset($data['spanish_number'])?$data['spanish_number']:''}}">
											<div class="required_error">&nbsp;</div>
										</div>
									</div>
									</div>
