...
.budget{
	...
	<section class="content-header">
	   <div class="container-fluid">
		  <div class="row mb-2">
			 <div class="col-sm-6">
				<h1>Olympic Scholarships for Coaches-Athlete365 Career+ Power Up Outreach Workshop</h1>
			 </div>
			 <div class="col-sm-6">
				<ol class="breadcrumb float-sm-right">
				   <li class="breadcrumb-item"><a href="#">Home</a></li>
				   <li class="breadcrumb-item active">Olympic Scholarships for Coaches-Athlete365 Career+ Power Up Outreach Workshop</li>
				</ol>
			 </div>
		  </div>
	   </div>
			 ...
			 <div class="col-md-12">
				<div class="card card-primary">
				   <div class="card-header">
					  <h3 class="card-title">Olympic Scholarships for Coaches-Athlete365 Career+ Power Up Outreach Workshop</h3>
				   </div>
				   <!-- /.card-header -->
				   <!-- form start -->
				   <form role="form" id="quickForm1" method="POST" action="{{ url('/forms/save_form1') }}" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
						 ...
						 <div class="sport mt-3">
						 	 <h3>Please suggest potential dates (Three months after the application date)</h3>
								...
								<div class="row">
									...
									<div class="form-row col">
										<div class="col">
											...
											<input type="date" value="<?php if(isset($data['e_activity_date'][0]) && !empty($data['e_activity_date'][0])) echo $data['e_activity_date'][0] ?>" class="form-control required" name="e_activity_date[]">
											 <div class="required_error">&nbsp;</div>
										</div>
									</div>
									</div>
							 ...
							 <div class="card sport_card ">
									...
									<div class="form-row col">
										<div class="col">
											...
											<input type="text" value="<?php if(isset($data['function'][0]) && !empty($data['function'][0])) echo $data['function'][0] ?>" class="form-control required" name="function[]">
											 <div class="required_error">&nbsp;</div>
										</div>
									</div>
									</div>
 ...
 <h3>Workshop Event Information</h3>
    ...
    float: left;">
                       ...
                       <div class="col-md-6">
							 ...
							 <div class="col-md-3">
									<div class="form-row col">
										<div class="col">
											<label><i class="fas fa-circle"></i>Number of workshops per year</label>
											<input type="text" value="<?php if(isset($data['workshops_yesr'][0]) && !empty($data['workshops_yesr'][0])) echo $data['workshops_yesr'][0] ?>" class="form-control required" name="workshops_yesr[]">
											 <div class="required_error">&nbsp;</div>
										</div>
									</div>
									</div>
									...
									<div class="form-row col">
										<div class="col">
											<label><i class="fas fa-circle"></i>Number of days available for the workshops</label>
											<input type="text" value="<?php if(isset($data['available'][0]) && !empty($data['available'][0])) echo $data['available'][0] ?>" class="form-control required" name="available[]">
											 <div class="required_error">&nbsp;</div>
										</div>
									</div>
									</div>
									...
									<div class="form-row col">
										<div class="col">
											<label><i class="fas fa-circle"></i>Number of hours available per day</label>
											<input type="text" value="<?php if(isset($data['available_day'][0]) && !empty($data['available_day'][0])) echo $data['available_day'][0] ?>" class="form-control required" name="available_day[]">
											 <div class="required_error">&nbsp;</div>
										</div>
									</div>
									</div>
									...
									<div class="form-row col">
										<div class="col">
											<label><i class="fas fa-circle"></i>Estimated number of participants</label>
											<input type="text" value="<?php if(isset($data['participants'][0]) && !empty($data['participants'][0])) echo $data['participants'][0] ?>" class="form-control required" name="participants[]">
											 <div class="required_error">&nbsp;</div>
										</div>
									</div>
									</div>
									...
									<div class="form-row col">
										<div class="col">
											<label><i class="fas fa-circle"></i>Number of participants ccurrentiy living in the city</label>
											<input type="text" value="<?php if(isset($data['participants_living'][0]) && !empty($data['participants_living'][0])) echo $data['participants_living'][0] ?>" class="form-control required" name="participants_living[]">
											 <div class="required_error">&nbsp;</div>
										</div>
									</div>
									</div>
									...
									<div class="form-row col">
										<div class="col">
											<label><i class="fas fa-circle"></i>Number of participants from other regions</label>
											<input type="text" value="<?php if(isset($data['participants_regions'][0]) && !empty($data['participants_regions'][0])) echo $data['participants_regions'][0] ?>" class="form-control required" name="participants_regions[]">
											 <div class="required_error">&nbsp;</div>
										</div>
									</div>
									</div>
									...
									<div class="form-row col">
										<div class="col">
											<label><i class="fas fa-circle"></i>Estimated age group</label>
											<input type="text" value="<?php if(isset($data['estimated_age'][0]) && !empty($data['estimated_age'][0])) echo $data['estimated_age'][0] ?>" class="form-control required" name="estimated_age[]">
											 <div class="required_error">&nbsp;</div>
										</div>
									</div>
									</div>
									...
									<div class="form-row col">
										<div class="col">
											<label><i class="fas fa-circle"></i>Venue where the NOC is planning to host the workshop</label>
											<input type="text" value="<?php if(isset($data['Venue_workshop'][0]) && !empty($data['Venue_workshop'][0])) echo $data['Venue_workshop'][0] ?>" class="form-control required" name="Venue_workshop[]">
											 <div class="required_error">&nbsp;</div>
										</div>
									</div>
									</div>
                                 ...
                                 <div class="row">
                                    <div class="col-md-12">
                        <label><i class="fas fa-circle"></i>Is there an Athletes’ Commission in place in your NOC?</label>
                                      </div>
                                    <br>
                                    <div class="col-md-6">
                      <div class="form-check form-check-inline">
  <input class="form-check-input" type="checkbox" id="inlineCheckbox1" name="advance_payment11" value="Yes" {{isset($data['advance_payment11']) && $data['advance_payment11']  == "Yes" ? 'checked' : ''}}/>
...
<div class="col-md-6">
<div class="form-check form-check-inline">
  <input class="form-check-input" type="checkbox" id="inlineCheckbox2" name="advance_payment21" value="No" {{isset($data['advance_payment21']) && $data['advance_payment21']  == "No" ? 'checked' : ''}}/>
...
<br>
						 <div class="row">
                                    <div class="col-md-12">
                        <label><i class="fas fa-circle"></i>lf your NOC does not have a qualified Career+ Outreach Educator, please provide the name of an AC representative/Olympian or NOC staff who you nominate to be trained in the future to deliver the Outreach Programme. (Subject to course calendar and availabilty)</label>
                                      </div>
                                    <br>
                                    <div class="col-md-12">
									<div class="form-row col">
							...
							<h3>Budget Proposal</h3>
							 <div class="card sport_card">
								<div class="d-md-flex align-items-center ">
								<div class="row ">
									<div class="Diploma_Certificate " id="container">
									<p>The following items are not covered by the ACT programme: promotional articles, administrative/ management fees, stipend for athletes, audio-visual /media or press services, welcome/Tarewell events, dinners or meals for the instructors and any other item not directly related to the logistics of the Athlete 365 Career+ outreach workshop. NOCs with local certified Career+ educators are allowed to include a perdiem for local Career+ educators who deliver the session. As a reference, UN rates of the oity/country can bbe used to estimate the daily perdiem</p>
									<?php
                                   ...
                                   <div class="col-md-12">
									...
									<div class="form-row col">
										<div class="col">
											...
											<input type="text"  id="totalSum" class="form-control required" name="budget[]" placeholder="0">
											 <div class="required_error">&nbsp;</div>
										</div>
									</div>
									</div>
