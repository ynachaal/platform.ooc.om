...
<form role="form" id="quickForm1" method="POST" action="http://websutility.in/client-projects/laravel/forms/save_form1" enctype="multipart/form-data">
   <input type="hidden" name="_token" value="4dFg4WteyQrcOXCxg6SJM6I3jJYCV7hjl4Vf4G7z">
   <div class="card-body">
   <input type="hidden" name="application_id" class="form-control" placeholder="Committee Name" value="0">
