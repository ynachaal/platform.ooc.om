...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1>Players Application form</h1>
            </div>
            <div class="col-sm-6">
                ...
                <div class="card card-primary">
                    ...
                    <form role="form" id="quickForm1" method="POST" action="{{ url('/forms/save_form1') }}" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            ...
                            <h3 class="form_header_2">CANDIDATE المرشح</h3>
                            ...
                            <div class="form-group col-md-12">
                                <label for="exampleInputEmail1" style="margin-top: 20px;">Passport – No.رقم الجواز</label>
                                <input type="text" name="passport" class="form-control" placeholder="Passport No" value="{{isset($data['passport'])? $data['passport'] : ''}}">
                            </div>
                            <div class="col-md-12 row">
                                <div class="form-group col-md-6">
                            ...
                            <div class="col-md-12 row">
                                <div class="form-group col-md-6">
                                    <label for="exampleInputEmail1">Telephone رقم الهاتف</label>
                                    <input type="text" name="telephone" class="form-control" placeholder="Telephone" value="{{isset($data['telephone'])? $data['telephone'] : ''}}">
                                </div>
                                <div class="form-group col-md-6">
                            ...
                            <div class="form-group col-md-12">
                                <label for="exampleInputEmail1" style="margin-top: 20px;">Residence (city, country) الإقامة (المدينة – الدولة)</label>
                                <input type="text" name="residence" class="form-control" placeholder="Residence" value="{{isset($data['residence'])? $data['residence'] : ''}}">
                            </div>
                            <div class="form-group col-md-12">
                                <label for="exampleInputEmail1" style="margin-top: 20px;">(Optional) – Other means of communication such as Skype, FB, Twitter, Instagram وسائل التواصل الاجتماعي (اختياري)</label>
                                <input type="text" name="communication" class="form-control" placeholder="Communication" value="{{isset($data['communication'])? $data['communication'] : ''}}">
                            </div>

                            <h3 class="form_header_2" style="margin-top: 20px;">Sporting details تفاصيل رياضية </h3>
                            <div class="form-group col-md-12">
                                <label for="exampleInputEmail1" style="margin-top: 20px;">Individual Olympic Sport (e.g. taekwondo) الرياضة الأولمبية الفردية (مثل التايكوندو)</label>
                                <input type="text" name="individual_olympic_sport" class="form-control" placeholder="Individual Olympic Sport" value="{{isset($data['individual_olympic_sport'])? $data['individual_olympic_sport'] : ''}}">
                            </div>
                            <div class="form-group col-md-12">
                                <label for="exampleInputEmail1" style="margin-top: 20px;">Discipline(s) / Event(s) التخصص / الحدث</label>
                                <input type="text" name="discipline" class="form-control" placeholder="Discipline(s) / Event(s)" value="{{isset($data['discipline'])? $data['discipline'] : ''}}">
                            </div>
                            <div class="col-md-12 row">
                                <div class="form-group col-md-6">
                                    <label for="exampleInputEmail1">National ranking الترتيب الوطني</label>
                                    <input type="text" name="national_ranking" class="form-control" placeholder="National ranking" value="{{isset($data['national_ranking'])? $data['national_ranking'] : ''}}">
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="exampleInputEmail1">International ranking الترتيب الدولي</label>
                                    <input type="text" name="international_ranking" class="form-control" placeholder="International ranking" value="{{isset($data['international_ranking'])? $data['international_ranking'] : ''}}">
                                </div>
                            </div>
                            <div class="form-group col-md-12">
                                <label for="exampleInputEmail1" style="margin-top: 20px;">Previous Olympic participation (Games & year) لمشاركة الاولمبية السابقة (الألعاب والسنة)</label>
                                <input type="text" name="previous_olympic_participation" class="form-control" placeholder="Previous Olympic participation" value="{{isset($data['previous_olympic_participation'])? $data['previous_olympic_participation'] : ''}}">
                            </div>
                            <div class="form-group col-md-12">
                                <label for="exampleInputEmail1">Primary sporting achievement(s)(Result, PB, competition and date) الإنجازات الرياضية الأساسية(النتيجة ، PB ، المنافسةوالتاريخ)</label>
                                <textarea class="form-control" name="primary_sporting_achievement" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{{isset($data['primary_sporting_achievement']) ? $data['primary_sporting_achievement'] : ''}}</textarea>
                            </div>
                            <div class="form-group col-md-12">
                                <label for="exampleInputEmail1" style="margin-top: 20px;">Training location (Address and details) موقع التدريب(العنوان والتفاصيل)</label>
                                <input type="text" name="training_location" class="form-control" placeholder="Training location" value="{{isset($data['training_location'])? $data['training_location'] : ''}}">
                            </div>
                            <p>Has the candidate benefited from one of the following Olympic Solidarity programmes?
                                هل استفاد المرشح من أحد برامج التضامن الأولمبي التالية؟</p>

                                <div class="form-group col-md-12">
                                <label for="exampleInputEmail1">(ما هي الألعاب الأولمبية التي اشترك اللاعب بها )</label>
                                <textarea class="form-control" name="participate" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{{isset($data['participate']) ? $data['participate'] : ''}}</textarea>
                            </div>
                            
                            <div class="col-md-12 row" style="margin-top: 20px;">
                                <div class="form-group col-md-12">
                                    <label for="exampleInputEmail1">غيرها</label>
                                    <label for="no">تذكر هنا</label>
                                </div>
                            </div>
                            <!-- <div class="col-md-12 row" style="margin-top: 20px;">
                                <div class="form-group col-md-12">
                                    <label for="exampleInputEmail1">For your candidate which option does your NOC prefer? ما الخيار المناسب لمرشحك</label><br>
                                    <input type="radio" id="yes" name="candidate_noc_prefer" value="yes" {{isset($data['candidate_noc_prefer']) && $data['candidate_noc_prefer']  == "yes" ? 'checked' : ''}}>
                                    <label for="yes">تدريب مستوى متقدم من خلال مراكز التضامن الأولمبي</label>
                                    <input type="radio" id="no" name="candidate_noc_prefer" value="no" {{isset($data['candidate_noc_prefer']) && $data['candidate_noc_prefer']  == "no" ? 'checked' : ''}}>
                                    <label for="no">تدريب محلي</label>
                                </div>
                            </div> -->
                            <div class="col-md-12 row" style="margin-top: 20px;">
                                <div class="form-group col-md-12">
                            ...
                            <div class="form-group col-md-12">
                                <label for="exampleInputEmail1">Candidate’s background and motivation for a scholarship خلفية المرشح ودوافعه للحصول على منحة دراسية </label>
                                <textarea class="form-control" name="candidate_background" placeholder="(To be completed by the athlete)" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{{isset($data['candidate_background']) ? $data['candidate_background'] : ''}}</textarea>
                            </div>
                            <h3 class="form_header_2" style="margin-top: 20px;">ATTACHMENTS REQUIRED المرفقات</h3>
