...
.budget{
	...
	<section class="content-header">
	   <div class="container-fluid">
		  <div class="row mb-2">
			 <div class="col-sm-6">
				<h1>Athlete Career Transition - Athletes Education - Masters Degree in Sports Ethics and Integrity</h1>
			 </div>
			 <div class="col-sm-6">
				<ol class="breadcrumb float-sm-right">
				   <li class="breadcrumb-item"><a href="#">Home</a></li>
				   <li class="breadcrumb-item active">Athlete Career Transition - Athletes Education - Masters Degree in Sports Ethics and Integrity</li>
				</ol>
			 </div>
		  </div>
	   </div>
			 ...
			 <div class="col-md-12">
				<div class="card card-primary">
				   <div class="card-header">
					  <h3 class="card-title">Athlete Career Transition - Athletes Education - Masters Degree in Sports Ethics and Integrity</h3>
				   </div>
				   <!-- /.card-header -->
				   <!-- form start -->
								...
								<div class="col-md-3">
									<div class="form-row col">
										<div class="col">
											...
											<input type="email" id="email" name="email" class="form-control required" placeholder="E-mail" value="{{isset($data['email'])? $data['email'] : ''}}">
											<div class="required_error">&nbsp;</div>
										</div>
									</div>
									</div>
