    ...
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                ...
                <h1>General Form (Candidate) 2</h1>
                    ...
                    <form role="form" id="quickForm1" method="POST" action="{{ url('/forms/save_form1') }}" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <input type="text" name="class_player" class="form-control" placeholder="الصفـــــــة (لاعب /مدرب/إداري)" value="{{isset($data['class_player'])? $data['class_player'] : ''}}">
                            </div>
                            <div class="form-group col-md-12">
                            ...
                            <p style="margin-top: 10px;">يرفق الطلب مع رسالة تغطية من الاتحاد / اللجنة ويتم تحميلها عبر النظام ويتم ارسال الأصل الى البريد الرسمي للجنة الأولمبية العمانية موجهة الى الأمين العام.</p>
