...
.budget{
	...
	<section class="content-header">
	   <div class="container-fluid">
		  <div class="row mb-2">
			 <div class="col-sm-6">
				<h1>NOC Administration Development - NOC Management Initiatives</h1>
			 </div>
			 <div class="col-sm-6">
				<ol class="breadcrumb float-sm-right">
				   <li class="breadcrumb-item"><a href="#">Home</a></li>
				   <li class="breadcrumb-item active">NOC Administration Development - NOC Management Initiatives</li>
				</ol>
			 </div>
		  </div>
	   </div>
			 ...
			 <div class="col-md-12">
				<div class="card card-primary">
				   <div class="card-header">
					  <h3 class="card-title">NOC Administration Development - NOC Management Initiatives</h3>
				   </div>
				   <!-- /.card-header -->
				   <!-- form start -->
				   <form role="form" id="quickForm1" method="POST" action="{{ url('/forms/save_form1') }}" enctype="multipart/form-data">
					  ...
					  <div class="col-md-12">
									<div class="form-row col">
										<div class="col">
											<label><i class="fas fa-circle" ></i>Activity Name</label>
											<input type="text" value="<?php if(isset($data['activity_date'][0]) && !empty($data['activity_date'][0])) echo $data['activity_date'][0] ?>" class="form-control required" name="activity_date[]">
								...
								<div class="row">
									...
									<div class="form-row col">
										<div class="col">
											...
											<input type="date" value="<?php if(isset($data['activity_date_start'][0]) && !empty($data['activity_date_start'][0])) echo $data['activity_date_start'][0] ?>" class="form-control required" name="activity_date_start[]">
											 <div class="required_error">&nbsp;</div>
										</div>
									</div>
									</div>
									...
									<div class="form-row col">
										<div class="col">
											...
											<input type="date" value="<?php if(isset($data['activity_date_end'][0]) && !empty($data['activity_date_end'][0])) echo $data['activity_date_end'][0] ?>" class="form-control required" name="activity_date_end[]">
											 <div class="required_error">&nbsp;</div>
										</div>
									</div>
									</div>
								 ...
								 <br>
								<h4>NOC Initiatives/Activities</h4>
									  <div class="card sport_card ">
										<div class="row">
									...
									<div class="form-row col">
										<div class="col">
											<p></i>The NOC Management Initiatives programme enables NOCs to strengthen their management structures by providing a contribution.
towards one-time projects and activities aiming to improve their management and operations and to guarantee minimum standards,
The funds can be used to cover the cost of</p>
          <li>introducing a new tool or concept;</li>
		  <li>training of paid staff or elected officals in skils related to their professional duties;</li>
		  <li>external expert assistance on a limited-time basis in order to facilitate the development or audit and revision of strategic plans,
policies, procedures and tools.</li>
		   
         <p>NOCs whose administrative structures need to be strengthened will particularly benefit from this program to ensure the following</p>
		 
		  <li>adequate financial management and governance structure:</li>
		  <li>strategic plan (including an action pian and a monitoring and evaluation system):?</li>
		  <li>properly trained human resources;</li>
		  <li>_IT tools adequate for the size of the NOC (hardware and software, cybersecurity, sufficient internet connection, document filing system and back-up, and accounting software); and</li>
		  <li>communication tools, such as an up-to-date website and/or active social media?presence.</li>
		  
		  <p >Applications for Management Initiatives must be submitted at least two months prior to the start of the project. We also invite you to add, if applicable, a copy of the service provider or the contract as well as any additional documents that will allow us to have a better understanding of your project.</p>
		  
		  <p>The technical and financial reports should be submitted no later than two months after the completion of the initiative. Any changes to the scope or schedule approved by Olympic Solidarity should be communicated as soon as possible to Olympic Solidarity</p>
		  <br>
		  <b>Please describe your NOC Management Initiative and how the funds will be spent, including the following information:</b>
		  <li>project description, timeline, name of expert/facilitator if applicable, type of expenses to be covered</li>
		  <li>type of product (software/hardware/etc.) to be purchased/upgraded (ff applicable)</li>
	...
	<div class="form-group">
		<textarea cols="10" rows="10" name="year_1" class="form-control textarea required">{{isset($data['year_1'])? $data['year_1'] : ''}}</textarea>
		<div class="required_error">&nbsp;</div>
	</div>
 </div>                       
								 </div>
								 <div class="col-md-12">
									 ...
									 <div class="card sport_card">
										<label><i class="fas fa-circle"></i>How is this initiative linked to your strategic plan (if your NOC has one)?</label>
											 
										<div class="form-group">
									<textarea cols="10" rows="10" name="year_2" class="form-control textarea required">{{isset($data['year_2'])? $data['year_2'] : ''}}</textarea>
									<div class="required_error">&nbsp;</div>
								</div>
									 </div>                         
								 </div>
								 <div class="col-md-12">
									 ...
									 <div class="card sport_card">
										<label><i class="fas fa-circle"></i>How will this initiative benefit your NOC once implementation has been completed? Please list anticipated project outcomes and results for beneficiaries in the short, medium and long-term.</label>
											 
										<div class="form-group">
									<textarea cols="10" rows="10" name="year_3" class="form-control textarea required">{{isset($data['year_3'])? $data['year_3'] : ''}}</textarea>
									<div class="required_error">&nbsp;</div>
								</div>
									 </div>                         
								 </div>
								 ...
								 <div class="col-md-12">
									 ...
									 <div class="card sport_card">
									 	<b>If resources are required for maintenance after the implementation of the initiative, how will your NOC ensure its continuation once</b>
										<label><i class="fas fa-circle"></i>Olympic Solidarity's contribution has been used (e.g. annual hosting fees and salary of an administrator for a new website developed through an NOC Management Initiative)?</label>
								 ...
								 <div class="col-md-12">
									 ...
									 <div class="card sport_card">
										<label><i class="fas fa-circle"></i>Where will you source additional funds if Olympic Solidarity does not cover the total cost?</label>
               ...
               <p>Please Provided a Detailed Budget for each Phase of The Project.</p>
               <h3>Detailed breakdown of budget requested from Olympic Solidarity </h3>
               <table style="margin-top: 20px;" id="container">
                                <tr>
                                    <th>Description</th>
                                    <th>Amount(OMR)</th>
                                </tr>
                                <tr>
                                    ...
                                    <td class="p-0"><input type="text" name="budget[0]" class="budget border-0 toSum" style="width: 100%;" value="{{isset($data['budget'][0])? $data['budget'][0] : ''}}"></td>
                                </tr>
                                <tr>
                                    <td class="p-0"><input type="text" name="proposal[1]" class="budget_proposal border-0" style="width: 100%;" value="{{isset($data['proposal'][1])? $data['proposal'][1] : ''}}"></td>
                                    <td class="p-0"><input type="text" name="budget[1]" class="budget border-0 toSum" style="width: 100%;" value="{{isset($data['budget'][1])? $data['budget'][1] : ''}}"></td>
                                </tr>
                                <tr>
                                    <td class="p-0"><input type="text" name="proposal[2]" class="budget_proposal border-0" style="width: 100%;" value="{{isset($data['proposal'][2])? $data['proposal'][2] : ''}}"></td>
                                    <td class="p-0"><input type="text" name="budget[2]" class="budget border-0 toSum" style="width: 100%;" value="{{isset($data['budget'][2])? $data['budget'][2] : ''}}"></td>
                                </tr>
                                <tr>
                                    <td class="p-0"><input type="text" name="proposal[3]" class="budget_proposal border-0" style="width: 100%;" value="{{isset($data['proposal'][3])? $data['proposal'][3] : ''}}"></td>
                                    <td class="p-0"><input type="text" name="budget[3]" class="budget border-0 toSum" style="width: 100%;" value="{{isset($data['budget'][3])? $data['budget'][3] : ''}}"></td>
                                </tr>
                                <tr>
                                    <td class="p-0"><input type="text" name="proposal[4]" class="budget_proposal border-0" style="width: 100%;" value="{{isset($data['proposal'][4])? $data['proposal'][4] : ''}}"></td>
                                    <td class="p-0"><input type="text" name="budget[4]" class="budget border-0 toSum" style="width: 100%;" value="{{isset($data['budget'][4])? $data['budget'][4] : ''}}"></td>
                                </tr>
                                <tr>
                                    <td class="p-0"><input type="text" name="proposal[5]" class="budget_proposal border-0" style="width: 100%;" value="{{isset($data['proposal'][5])? $data['proposal'][5] : ''}}"></td>
                                    <td class="p-0"><input type="text" name="budget[5]" class="budget border-0 toSum" style="width: 100%;" value="{{isset($data['budget'][5])? $data['budget'][5] : ''}}"></td>
                                </tr>
                                <tr>
                                    <td class="p-0"><input type="text" name="proposal[6]" class="budget_proposal border-0" style="width: 100%;" value="{{isset($data['proposal'][6])? $data['proposal'][6] : ''}}"></td>
                                    <td class="p-0"><input type="text" name="budget[6]" class="budget border-0 toSum" style="width: 100%;" value="{{isset($data['budget'][6])? $data['budget'][6] : ''}}"></td>
                                </tr>
                                <tr>
                                    <td class="p-0"><input type="text" name="proposal[7]" class="budget_proposal border-0" style="width: 100%;" value="{{isset($data['proposal'][7])? $data['proposal'][7] : ''}}"></td>
                                    <td class="p-0"><input type="text" name="budget[7]" class="budget border-0 toSum" style="width: 100%;" value="{{isset($data['budget'][7])? $data['budget'][7] : ''}}"></td>
                                </tr>
                                <tr>
                                    <td class="p-0"><input type="text" name="proposal[8]" class="budget_proposal border-0" style="width: 100%;" value="{{isset($data['proposal'][8])? $data['proposal'][8] : ''}}"></td>
                                    <td class="p-0"><input type="text" name="budget[8]" class="budget border-0 toSum" style="width: 100%;" value="{{isset($data['budget'][8])? $data['budget'][8] : ''}}"></td>
                                </tr>
                                <tr>
                                    <td class="p-0"><input type="text" name="proposal[9]" class="budget_proposal border-0" style="width: 100%;" value="{{isset($data['proposal'][9])? $data['proposal'][9] : ''}}"></td>
                                    <td class="p-0"><input type="text" name="budget[9]" class="budget border-0 toSum" style="width: 100%;" value="{{isset($data['budget'][9])? $data['budget'][9] : ''}}"></td>
                                </tr>
                                <tr>
                                    <td class="p-0"><input type="text" name="proposal[10]" class="budget_proposal border-0" style="width: 100%;" value="{{isset($data['proposal'][10])? $data['proposal'][10] : ''}}"></td>
                                    <td class="p-0"><input type="text" name="budget[10]" class="budget border-0 toSum" style="width: 100%;" value="{{isset($data['budget'][10])? $data['budget'][10] : ''}}"></td>
                                </tr>
                                <tr>
                                    <td class="p-0"><input type="text" name="proposal[11]" class="budget_proposal border-0 toSum" style="width: 100%;" value="{{isset($data['proposal'][11])? $data['proposal'][11] : ''}}"></td>
                                    <td class="p-0"><input type="text" name="budget[11] " class="budget border-0 toSum" style="width: 100%;" value="{{isset($data['budget'][11])? $data['budget'][11] : ''}}"></td>
                                </tr>
                                <tr>
                                    <td>Total budget requested (OMR)</td>
                                    <td class="p-0"><input type="text" id="totalSum"   class="budget border-0" style="width: 100%;" value=" " readonly></td>
                                </tr>
                            </table>
    ...
    $('#totalSum').val(sum);
			   ...
			   <div class="sport">
							<h3>Other sources of funding: Please list organisations providing additional funds for this project (including your NOC) andfor what type of expenditures</h3>
							 ...
							 <table style="margin-top: 20px;">
                                ...
                                <tr>
                                    ...
                                    <td class="p-0"><input type="text" name="amount_usd[0]" class="amount_usd border-0" style="width: 100%;" value="{{isset($data['amount_usd'][0])? $data['amount_usd'][0] : ''}}"></td>
                                </tr>
                                <tr>
                                    <td class="p-0"><input type="text" name="organisation[1]" class="amount_usd_organisation border-0" style="width: 100%;" value="{{isset($data['organisation'][1])? $data['organisation'][1] : ''}}"></td>
                                    ...
                                    <td class="p-0"><input type="text" name="amount_usd[1]" class="amount_usd border-0" style="width: 100%;" value="{{isset($data['amount_usd'][1])? $data['amount_usd'][1] : ''}}"></td>
                                </tr>
                                <tr>
                                    <td class="p-0"><input type="text" name="organisation[2]" style="width: 100%;" class="amount_usd_organisation border-0" value="{{isset($data['organisation'][2])? $data['organisation'][2] : ''}}"></td>
                                    ...
                                    <td class="p-0"><input type="text" name="amount_usd[2]" style="width: 100%;" class="amount_usd border-0" value="{{isset($data['amount_usd'][2])? $data['amount_usd'][2] : ''}}"></td>
                                </tr>
                                <tr>
                                    <td class="p-0"><input type="text" name="organisation[3]" style="width: 100%;" class="amount_usd_organisation border-0" value="{{isset($data['organisation'][3])? $data['organisation'][3] : ''}}"></td>
                                    ...
                                    <td class="p-0"><input type="text" style="width: 100%;" name="amount_usd[3]" class="amount_usd border-0" value="{{isset($data['amount_usd'][3])? $data['amount_usd'][3] : ''}}"></td>
                                </tr>
                                <tr>
                                    <td class="p-0"><input type="text" name="organisation[4]" style="width: 100%;" class="amount_usd_organisation border-0" value="{{isset($data['organisation'][4])? $data['organisation'][4] : ''}}"></td>
									 <td class="p-0"><input type="text" name="expenditure[4]" style="width: 100%;" class="budget_organisation border-0" style="width: 100%;" value="{{isset($data['expenditure'][4])? $data['expenditure'][4] : ''}}"></td>
                                    <td class="p-0"><input type="text" name="amount_usd[4]" style="width: 100%;" class="amount_usd border-0" value="{{isset($data['amount_usd'][4])? $data['amount_usd'][4] : ''}}"></td>
                                </tr>
                                <tr>
                                    <td class="p-0"><input type="text" name="organisation[5]" style="width: 100%;" class="amount_usd_organisation border-0" value="{{isset($data['organisation'][5])? $data['organisation'][5] : ''}}"></td>
                                    ...
                                    <td class="p-0"><input type="text" name="amount_usd[5]" style="width: 100%;" class="amount_usd border-0" value="{{isset($data['amount_usd'][5])? $data['amount_usd'][5] : ''}}"></td>
                                </tr>
                                <tr>
                                    <td class="p-0"><input type="text" name="organisation[6]" style="width: 100%;" class="amount_usd_organisation border-0" value="{{isset($data['organisation'][6])? $data['organisation'][6] : ''}}"></td>
                                    ...
                                    <td class="p-0"><input type="text" name="amount_usd[6]" style="width: 100%;" class="amount_usd border-0" value="{{isset($data['amount_usd'][6])? $data['amount_usd'][6] : ''}}"></td>
                                </tr>
                                <tr>
                                    <td class="p-0"><input type="text" name="organisation[7]" style="width: 100%;" class="amount_usd_organisation border-0" value="{{isset($data['organisation'][7])? $data['organisation'][7] : ''}}"></td>
                                    ...
                                    <td class="p-0"><input type="text" name="amount_usd[7]" style="width: 100%;" class="amount_usd border-0" value="{{isset($data['amount_usd'][7])? $data['amount_usd'][7] : ''}}"></td>
                                </tr>
                                <tr>
                                    <td class="p-0"><input type="text" name="organisation[8]" style="width: 100%;" class="amount_usd_organisation border-0" value="{{isset($data['organisation'][8])? $data['organisation'][8] : ''}}"></td>
                                    ...
                                    <td class="p-0"><input type="text" name="amount_usd[8]" style="width: 100%;" class="amount_usd border-0" value="{{isset($data['amount_usd'][8])? $data['amount_usd'][8] : ''}}"></td>
                                </tr>
                                <tr>
                                    <td class="p-0"><input type="text" name="organisation[9]" style="width: 100%;" class="amount_usd_organisation border-0" value="{{isset($data['organisation'][9])? $data['organisation'][9] : ''}}"></td>
                                    ...
                                    <td class="p-0"><input type="text" name="amount_usd[9]" style="width: 100%;" class="amount_usd border-0" value="{{isset($data['amount_usd'][9])? $data['amount_usd'][9] : ''}}"></td>
                                </tr>
                                <tr>
                                    <td class="p-0"><input type="text" name="organisation[10]" style="width: 100%;" class="amount_usd_organisation border-0" value="{{isset($data['organisation'][10])? $data['organisation'][10] : ''}}"></td>
                                    ...
                                    <td class="p-0"><input type="text" name="amount_usd[10]" style="width: 100%;" class="amount_usd border-0" value="{{isset($data['amount_usd'][10])? $data['amount_usd'][10] : ''}}"></td>
                                </tr>
                                <tr>
                                    <td class="p-0"><input type="text" name="organisation[11]" style="width: 100%;" class="amount_usd_organisation border-0" value="{{isset($data['organisation'][11])? $data['organisation'][11] : ''}}"></td>
                                    ...
                                    <td class="p-0"><input type="text" name="amount_usd[11]" style="width: 100%;" class="amount_usd border-0" value="{{isset($data['amount_usd'][11])? $data['amount_usd'][11] : ''}}"></td>
                                </tr>
                                <tr>
                                    <td>Total amount_usd requested (OMR)</td>
                                    <td></td>
                                    <td class="p-0"><input type="text" style="width: 100%;" name="total_expenditure" class="amount_usd border-0" value="{{isset($data['total_expenditure'])? $data['total_expenditure'] : ''}}" readonly></td>
                                </tr>
                            </table> 
							 </div> 
				  ...
				  <br>
					  ...
					  <div class="required_error">&nbsp;</div>
					  <div class="col " >
						<input type="radio" id="yes" name="advance_payment"  value="single" {{isset($data['advance_payment']) && $data['advance_payment']  == "single" ? 'checked' : ''}}   required>
						<label for="male">Yes</label>
						<input type="radio" id="no" name="advance_payment" value="married" {{isset($data['advance_payment']) && $data['advance_payment']  == "married" ? 'checked' : ''}} required>
