							...
							<h3>Personal Details</h3>
							 <div class="card sport_card">
								<div class="d-md-flex align-items-center">
									...
									<div class="form-row col">
										<div class="col">
											<label><i class="fas fa-circle"></i>Priority</label>
											<input type="text" required class="form-control required" value="{{isset($data['priority'])? $data['priority'] : ''}}" name="priority">
										</div>
									</div>
									</div>
									</div>
							 ...
							 <div class="card sport_card">
								...
								<?php } ?>
									...
									<div class="form-row col">
										<div class="col">
											<label>Event</label>
											<input type="text" class="form-control " value="{{isset($data['event'])? $data['event'] : ''}}" name="event">
											 <div class="required_error">&nbsp;</div>
									...
									<div class="form-row col">
										<div class="col">
											<label></i>IF</label>
											<input type="text" class="form-control " value="{{isset($data['if_game'])? $data['if_game'] : ''}}" name="if_game">
											 <div class="required_error">&nbsp;</div>
