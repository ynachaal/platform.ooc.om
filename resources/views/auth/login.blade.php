...
<div class="login-box 1">
    <div class="login-logo">
        ...
        <a href="#"><img style="height:120px" src="{{url('images/login_logo.png')}}?time=1" /></a>
    </div>
    <div class="login-logo">
    ...
    <div class="card">
        <div class="card-body login-card-body">
            <form method="POST" action="{{ route('login') }}" id="my_captcha_form">
                @csrf
                ...
                <div class="row">
                    ...
                    <!-- /.col -->
                    <div class="col-4">
                        <button type="submit" class="btn btn-primary btn-block mt-2">تسجيل الدخول</button>
                    </div>
                    <!-- /.col -->
                </div>
                <div class="forgot_password text-left">
                     <a href="{{url('/forgot-password')}}">@lang('custom.forgot_password')</a>
                </div>
            </form>
            <script>
