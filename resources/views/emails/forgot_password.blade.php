                        ...
                        <tr>
                            <td style="{{ $style['email-masthead'] }}">
                                <a style="{{ $fontFamily }} {{ $style['email-masthead_name'] }}" href="{{ url('/') }}" target="_blank">
                                   ...
                                   <img style="width: 150px;" src="https://platform.ooc.om/images/logo_inside.png" alt="" /> 
                                </a>
                            </td>
                        </tr>
                        <tr>
                                ...
                                <table style="{{ $style['email-body_inner'] }}" align="center" width="570" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td style="{{ $fontFamily }} {{ $style['email-body_cell'] }}">
                                            <!-- Greeting -->
                                            <p>@lang('custom.hi') {{$name}},</p>
                                         
										<p>تم إجراء طلب إعادة تعيين كلمة المرور للحساب على https://platform.ooc.om/. يرجى الضغط على الرابط التالي لإعادة تعيين كلمة المرور الخاصة بك. إذا لم تكن قد قدمت أي طلب ، يرجى تجاهل هذا البريد الإلكتروني.</p>
