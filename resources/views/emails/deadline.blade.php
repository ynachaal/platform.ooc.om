                                ...
                                <table style="{{ $style['email-body_inner'] }}" align="center" width="570" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td style="{{ $fontFamily }} {{ $style['email-body_cell'] }}">
											...
											<p>هذه الرسالة الإلكترونية لإبلاغك بأن الموعد النهائي لتقديم طلبك هو <?php echo $user_details['deadline'] ?>. يرجى إرسال جميع المستندات في أقرب وقت
ممكن لتفادي اغلاق البرنامج .
